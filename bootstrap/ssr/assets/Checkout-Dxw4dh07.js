      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$2), { class: "border-zinc-200 shadow-none bg-white rounded-xl overflow-hidden sticky top-4" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="aspect-video relative overflow-hidden border-b border-zinc-50"${_scopeId2}>`);
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$3), {
                    variant: "secondary",
                    class: "h-4 text-[8px] font-black uppercase tracking-widest bg-white/90 text-zinc-900 border-none"
                  }, {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$4), { class: "p-4 border-b border-zinc-50" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        return [
                          createVNode("div", { class: "space-y-2.5" }, [
                            ...
                            createVNode("div", { class: "flex justify-between items-center text-[11px] font-medium text-zinc-500" }, [
                              ...
                              createVNode("span", { class: "text-emerald-600 font-black" }, "مجاني")
                            ]),
                            createVNode("div", { class: "flex justify-between items-center text-[11px] font-medium text-zinc-500" }, [
                          ...
                          createVNode(unref(_sfc_main$7), { class: "bg-zinc-50" }),
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$8), { class: "bg-zinc-50/30 p-4 flex flex-col gap-3" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(CheckCircle2), { class: "h-3 w-3 text-emerald-500" }, null, _parent4, _scopeId3));
                        ...
                        return [
                          ...
                          createVNode("div", { class: "w-full space-y-2" }, [
                            createVNode("div", { class: "flex items-center gap-2 text-[10px] font-bold text-zinc-600" }, [
                              createVNode(unref(CheckCircle2), { class: "h-3 w-3 text-emerald-500" }),
                  ...
                  return [
                    createVNode("div", { class: "aspect-video relative overflow-hidden border-b border-zinc-50" }, [
                    ...
                    createVNode(unref(_sfc_main$4), { class: "p-4 border-b border-zinc-50" }, {
                      default: withCtx(() => [
                        createVNode(unref(_sfc_main$5), { class: "text-[10px] font-black uppercase tracking-widest text-zinc-400" }, {
                          default: withCtx(() => [
                            createTextVNode("تفاصيل الفاتورة")
                    ...
                    createVNode(unref(_sfc_main$8), { class: "bg-zinc-50/30 p-4 flex flex-col gap-3" }, {
                      default: withCtx(() => [
                        createVNode("h4", { class: "text-[9px] font-black uppercase tracking-widest text-zinc-400 w-full mb-1" }, "مزايا الاشتراك:"),
                        createVNode("div", { class: "w-full space-y-2" }, [
                          createVNode("div", { class: "flex items-center gap-2 text-[10px] font-bold text-zinc-600" }, [
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$2), { class: "border-zinc-200 shadow-none bg-white rounded-xl overflow-hidden" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$4), { class: "p-4 border-b border-zinc-50 flex flex-row items-center justify-between" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(_sfc_main$5), { class: "text-[11px] font-black uppercase tracking-widest flex items-center gap-2" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="h-7 w-7 rounded-lg bg-zinc-900 text-white flex items-center justify-center shadow-md"${_scopeId4}>`);
                              _push5(ssrRenderComponent(unref(CreditCard), { class: "h-3.5 w-3.5" }, null, _parent5, _scopeId4));
                              _push5(`</div> بطاقة الائتمان / الخصم `);
                            } else {
                              return [
                                createVNode("div", { class: "h-7 w-7 rounded-lg bg-zinc-900 text-white flex items-center justify-center shadow-md" }, [
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$a), {
                          ...
                          class: "h-9 text-[12px] font-medium border-zinc-100 bg-zinc-50/20"
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$a), {
                          ...
                          class: "h-9 text-[12px] font-mono font-bold pl-12 border-zinc-100 bg-zinc-50/20 tracking-widest"
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(unref(Lock), { class: "absolute left-3 top-2.5 h-4 w-4 text-zinc-200" }, null, _parent4, _scopeId3));
                          ...
                          createVNode("div", { class: "space-y-4" }, [
                            ...
                            createVNode("div", { class: "space-y-1.5" }, [
                              ...
                              createVNode("div", { class: "relative" }, [
                                ...
                                createVNode(unref(Lock), { class: "absolute left-3 top-2.5 h-4 w-4 text-zinc-200" })
                              ])
                            ]),
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$8), { class: "bg-zinc-50/50 p-4 flex items-center gap-3 border-t border-zinc-50" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="h-7 w-7 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center shrink-0 shadow-inner"${_scopeId3}>`);
                        ...
                        return [
                          createVNode("div", { class: "h-7 w-7 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center shrink-0 shadow-inner" }, [
                  ...
                  return [
                    createVNode(unref(_sfc_main$4), { class: "p-4 border-b border-zinc-50 flex flex-row items-center justify-between" }, {
                      default: withCtx(() => [
                        createVNode(unref(_sfc_main$5), { class: "text-[11px] font-black uppercase tracking-widest flex items-center gap-2" }, {
                          default: withCtx(() => [
                            createVNode("div", { class: "h-7 w-7 rounded-lg bg-zinc-900 text-white flex items-center justify-center shadow-md" }, [
                    ...
                    createVNode(unref(_sfc_main$8), { class: "bg-zinc-50/50 p-4 flex items-center gap-3 border-t border-zinc-50" }, {
                      default: withCtx(() => [
                        createVNode("div", { class: "h-7 w-7 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center shrink-0 shadow-inner" }, [
                          createVNode(unref(ShieldCheck), { class: "h-3.5 w-3.5" })
                        ]),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$b), {
                    variant: "ghost",
                    class: "h-8 text-[11px] font-black uppercase tracking-widest text-zinc-400 hover:text-zinc-900 rounded-full px-6 transition-all"
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (isProcessing.value) {
                    ...
                    _push3(ssrRenderComponent(unref(Wallet), { class: "h-4 w-4 opacity-50 group-hover:translate-x-1 transition-transform" }, null, _parent3, _scopeId2));
                    _push3(`</span>`);
                  }
                } else {
                  return [
                    isProcessing.value ? (openBlock(), createBlock(unref(Loader2), {
                      ...
                      createVNode(unref(Wallet), { class: "h-4 w-4 opacity-50 group-hover:translate-x-1 transition-transform" })
                    ]))
                  ];
                }
              }),
                  ...
                  createVNode("div", { class: "w-full max-w-6xl mx-auto" }, [
                    createVNode("div", { class: "grid grid-cols-1 lg:grid-cols-12 gap-8 items-start" }, [
                      createVNode("div", { class: "lg:col-span-5 order-2 lg:order-1" }, [
                        createVNode(unref(_sfc_main$2), { class: "border-zinc-200 shadow-none bg-white rounded-xl overflow-hidden sticky top-4" }, {
                          default: withCtx(() => [
                            createVNode("div", { class: "aspect-video relative overflow-hidden border-b border-zinc-50" }, [
                              __props.course.thumbnail ? (openBlock(), createBlock("img", {
                                key: 0,
                      ...
                      createVNode("div", { class: "lg:col-span-7 order-1 lg:order-2 space-y-6" }, [
                        ...
                        createVNode(unref(_sfc_main$2), { class: "border-zinc-200 shadow-none bg-white rounded-xl overflow-hidden" }, {
                          default: withCtx(() => [
                            createVNode(unref(_sfc_main$4), { class: "p-4 border-b border-zinc-50 flex flex-row items-center justify-between" }, {
                              default: withCtx(() => [
                                createVNode(unref(_sfc_main$5), { class: "text-[11px] font-black uppercase tracking-widest flex items-center gap-2" }, {
