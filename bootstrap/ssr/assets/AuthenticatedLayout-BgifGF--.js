...
const _sfc_main$2 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="flex h-11 items-center px-4 border-b border-brand-hairline">`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="flex h-11 items-center justify-between px-4 border-b border-brand-hairline">`);
      _push(ssrRenderComponent(unref(Link), {
        href: "/",
        class: "flex items-center gap-2 font-bold tracking-tight"
      }, {
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="flex-1 flex flex-col min-w-0 overflow-hidden relative z-10"><header class="shrink-0 bg-[var(--card)] border-b border-[var(--border)] sticky top-0 z-40 flex items-center justify-between px-4 lg:px-6 shadow-none pt-[calc(0.25rem+env(safe-area-inset-top,0px))] pb-1 min-h-[calc(2.75rem+env(safe-area-inset-top,0px))]"><div class="flex items-center gap-3"><button class="lg:hidden p-1.5 rounded pt-[env(safe-area-inset-top,0px)]">`);
      _push(ssrRenderComponent(unref(Menu), { class: "h-4 w-4 text-[var(--foreground)]" }, null, _parent));
      _push(`</button><div class="text-[12px] font-normal tracking-tight text-[var(--foreground)] flex items-center gap-2">`);
      if (__props.breadcrumbs && __props.breadcrumbs.length) {
        ...
        ssrRenderList(__props.breadcrumbs, (item, index) => {
          ...
          if (item.url && index < __props.breadcrumbs.length - 1) {
            ...
            _push(`<span class="text-[var(--foreground)] font-normal">${ssrInterpolate(item.label)}</span>`);
          }
          if (index < __props.breadcrumbs.length - 1) {
            _push(ssrRenderComponent(unref(ChevronLeft), { class: "h-3.5 w-3.5 text-[var(--muted-foreground)] opacity-60" }, null, _parent));
          } else {
            _push(`<!---->`);
          }
          _push(`<!--]-->`);
