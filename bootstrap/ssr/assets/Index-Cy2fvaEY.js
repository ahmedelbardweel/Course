...
import { ChevronLeft, Plus, BookOpen, GraduationCap, Users, PlayCircle, HelpCircle, Trophy, Check, X, Edit, Trash2 } from "lucide-vue-next";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.courses.length === 0) {
              ...
              _push2(ssrRenderComponent(unref(BookOpen), { class: "h-12 w-12 text-zinc-100 mb-4" }, null, _parent2, _scopeId));
                      ...
                      _push3(ssrRenderComponent(unref(_sfc_main$7), { class: "px-3 pb-3 pt-0 flex-1 space-y-3" }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            ...
                            _push4(ssrRenderComponent(unref(HelpCircle), { class: "h-3 w-3 text-zinc-400 mb-1" }, null, _parent4, _scopeId3));
                            ...
                            _push4(ssrRenderComponent(unref(Trophy), { class: "h-3 w-3 text-zinc-400 mb-1" }, null, _parent4, _scopeId3));
                            ...
                            return [
                              ...
                              createVNode("div", { class: "grid grid-cols-3 gap-1 pt-1 border-t border-zinc-50" }, [
                                ...
                                createVNode("div", { class: "flex flex-col items-center p-1.5 rounded-md bg-zinc-50/50" }, [
                                  createVNode(unref(HelpCircle), { class: "h-3 w-3 text-zinc-400 mb-1" }),
                                ...
                                createVNode("div", { class: "flex flex-col items-center p-1.5 rounded-md bg-zinc-50/50" }, [
                                  createVNode(unref(Trophy), { class: "h-3 w-3 text-zinc-400 mb-1" }),
                ...
                createVNode("main", { class: "flex-1 p-4 lg:p-6 text-right" }, [
                  createVNode("div", { class: "w-full space-y-6 max-w-full mx-auto" }, [
                    __props.courses.length === 0 ? (openBlock(), createBlock("div", {
                      ...
                      createVNode(unref(BookOpen), { class: "h-12 w-12 text-zinc-100 mb-4" }),
