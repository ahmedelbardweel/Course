  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="p-6 bg-white rounded-2xl overflow-hidden relative"${_scopeId}><div class="absolute top-0 left-0 w-full h-1 bg-red-500"${_scopeId}></div><div class="flex items-center gap-3 mb-6 border-b border-zinc-50 pb-4"${_scopeId}><div class="h-10 w-10 rounded-xl bg-red-50 text-red-600 flex items-center justify-center shadow-inner"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(AlertTriangle), { class: "h-5 w-5" }, null, _parent2, _scopeId));
            _push2(`</div><div${_scopeId}><h2 class="text-[14px] font-black text-zinc-900 uppercase tracking-tight"${_scopeId}>هل أنت متأكد من حذف الحساب؟</h2><p class="text-[10px] text-zinc-400 font-bold uppercase tracking-widest mt-0.5"${_scopeId}>لا يمكن التراجع عن هذا الإجراء</p></div></div><p class="text-[12px] text-zinc-500 font-medium leading-relaxed mb-6"${_scopeId}> بمجرد حذف الحساب، سيتم مسح كافة بياناتك وتفاعلاتك من المنصة بشكل نهائي. يرجى إدخال كلمة المرور الخاصة بك لتأكيد طلب الحذف. </p><div class="space-y-2 mb-8"${_scopeId}>`);
            ...
            if (unref(form).errors.password) {
              _push2(`<div class="text-[10px] text-red-500 font-bold"${_scopeId}>${ssrInterpolate(unref(form).errors.password)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$2), {
              variant: "ghost",
              onClick: closeModal,
              class: "h-9 text-[11px] font-black px-6 rounded-xl text-zinc-400 hover:text-zinc-900 hover:bg-zinc-50 transition-all"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            return [
              createVNode("div", { class: "p-6 bg-white rounded-2xl overflow-hidden relative" }, [
                createVNode("div", { class: "absolute top-0 left-0 w-full h-1 bg-red-500" }),
                createVNode("div", { class: "flex items-center gap-3 mb-6 border-b border-zinc-50 pb-4" }, [
                  createVNode("div", { class: "h-10 w-10 rounded-xl bg-red-50 text-red-600 flex items-center justify-center shadow-inner" }, [
                    createVNode(unref(AlertTriangle), { class: "h-5 w-5" })
                  ]),
                  createVNode("div", null, [
                    createVNode("h2", { class: "text-[14px] font-black text-zinc-900 uppercase tracking-tight" }, "هل أنت متأكد من حذف الحساب؟"),
                    createVNode("p", { class: "text-[10px] text-zinc-400 font-bold uppercase tracking-widest mt-0.5" }, "لا يمكن التراجع عن هذا الإجراء")
                  ])
                ]),
                createVNode("p", { class: "text-[12px] text-zinc-500 font-medium leading-relaxed mb-6" }, " بمجرد حذف الحساب، سيتم مسح كافة بياناتك وتفاعلاتك من المنصة بشكل نهائي. يرجى إدخال كلمة المرور الخاصة بك لتأكيد طلب الحذف. "),
