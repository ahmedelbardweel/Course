      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="mb-8 text-center sm:text-right"${_scopeId}><h1 class="text-2xl font-bold tracking-tight text-zinc-950"${_scopeId}>ابدأ رحلتك اليوم</h1><p class="text-[13px] text-zinc-500 mt-1.5 leading-relaxed"${_scopeId}>انضم إلى مجتمع &quot;كورس&quot; الرائد وابدأ في بناء مستقبلك التعليمي والمهني.</p></div><form class="space-y-5"${_scopeId}><div class="space-y-2"${_scopeId}>`);
            ...
            _push2(`</div><p class="text-[10px] text-zinc-400 pr-1.5 leading-relaxed"${_scopeId}>نستخدم هذه البيانات لبناء مسارات تعلم تفاعلية ومخصصة لك.</p></div><div class="grid grid-cols-1 sm:grid-cols-2 gap-4"${_scopeId}><div class="space-y-2"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(_sfc_main$2), {
              for: "password",
              class: "text-zinc-700 font-semibold text-[11px] uppercase tracking-wider"
            }, {
            ...
            if (unref(form).errors.password) {
              _push2(`<div class="col-span-1 sm:col-span-2 text-[11px] font-bold text-red-600 bg-red-50 border border-red-100 px-3 py-1.5 rounded-lg flex items-center gap-1.5 mt-1"${_scopeId}>`);
              _push2(ssrRenderComponent(unref(AlertCircle), { class: "h-3.5 w-3.5 shrink-0" }, null, _parent2, _scopeId));
            ...
            _push2(`<div class="mt-6 text-center text-[12px]"${_scopeId}><span class="text-zinc-500"${_scopeId}>لديك حساب بالفعل؟ </span>`);
            ...
            return [
              ...
              createVNode("div", { class: "mb-8 text-center sm:text-right" }, [
                createVNode("h1", { class: "text-2xl font-bold tracking-tight text-zinc-950" }, "ابدأ رحلتك اليوم"),
                createVNode("p", { class: "text-[13px] text-zinc-500 mt-1.5 leading-relaxed" }, 'انضم إلى مجتمع "كورس" الرائد وابدأ في بناء مستقبلك التعليمي والمهني.')
              ]),
              createVNode("form", {
                ...
                createVNode("div", { class: "space-y-2" }, [
                  ...
                  createVNode("p", { class: "text-[10px] text-zinc-400 pr-1.5 leading-relaxed" }, "نستخدم هذه البيانات لبناء مسارات تعلم تفاعلية ومخصصة لك.")
                ]),
                createVNode("div", { class: "grid grid-cols-1 sm:grid-cols-2 gap-4" }, [
                  ...
                  unref(form).errors.password ? (openBlock(), createBlock("div", {
                    key: 0,
                    class: "col-span-1 sm:col-span-2 text-[11px] font-bold text-red-600 bg-red-50 border border-red-100 px-3 py-1.5 rounded-lg flex items-center gap-1.5 mt-1"
                  }, [
                    createVNode(unref(AlertCircle), { class: "h-3.5 w-3.5 shrink-0" }),
