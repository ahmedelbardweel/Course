          ...
          if (_push2) {
            ...
            if (__props.isEnrolled) {
              ...
              _push2(ssrRenderComponent(unref(_sfc_main$3), {
                size: "sm",
                variant: "secondary",
                class: "h-8 text-[10px] font-black rounded-full px-4 shadow-xl"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$4), { class: "p-3 space-y-1" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex items-center gap-1 mb-0.5"${_scopeId2}><div class="flex items-center text-amber-400"${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(Star), { class: "h-2.5 w-2.5 fill-amber-400" }, null, _parent3, _scopeId2));
                  _push3(ssrRenderComponent(unref(Star), { class: "h-2.5 w-2.5 fill-amber-400" }, null, _parent3, _scopeId2));
                  _push3(ssrRenderComponent(unref(Star), { class: "h-2.5 w-2.5 fill-amber-400" }, null, _parent3, _scopeId2));
                  _push3(ssrRenderComponent(unref(Star), { class: "h-2.5 w-2.5 fill-amber-400" }, null, _parent3, _scopeId2));
                  _push3(ssrRenderComponent(unref(Star), { class: "h-2.5 w-2.5 fill-amber-400/30" }, null, _parent3, _scopeId2));
                  _push3(`</div><span class="text-[9px] font-black text-zinc-300"${_scopeId2}>(4.8)</span></div>`);
                  _push3(ssrRenderComponent(unref(_sfc_main$5), { class: "text-[12px] font-bold text-zinc-900 line-clamp-1 group-hover:text-emerald-600 transition-colors leading-tight" }, {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$6), { class: "text-[10px] line-clamp-2 h-7 leading-relaxed text-zinc-400 font-medium" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                  ...
                  return [
                    createVNode("div", { class: "flex items-center gap-1 mb-0.5" }, [
                      createVNode("div", { class: "flex items-center text-amber-400" }, [
                        createVNode(unref(Star), { class: "h-2.5 w-2.5 fill-amber-400" }),
                        createVNode(unref(Star), { class: "h-2.5 w-2.5 fill-amber-400" }),
                        createVNode(unref(Star), { class: "h-2.5 w-2.5 fill-amber-400" }),
                        createVNode(unref(Star), { class: "h-2.5 w-2.5 fill-amber-400" }),
                        createVNode(unref(Star), { class: "h-2.5 w-2.5 fill-amber-400/30" })
                      ]),
                      createVNode("span", { class: "text-[9px] font-black text-zinc-300" }, "(4.8)")
                    ]),
                    createVNode(unref(_sfc_main$5), { class: "text-[12px] font-bold text-zinc-900 line-clamp-1 group-hover:text-emerald-600 transition-colors leading-tight" }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(__props.title), 1)
                      ]),
                      _: 1
                    }),
                    createVNode(unref(_sfc_main$6), { class: "text-[10px] line-clamp-2 h-7 leading-relaxed text-zinc-400 font-medium" }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(__props.description), 1)
                      ]),
                      _: 1
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$7), { class: "p-3 pt-0 mt-auto border-t border-zinc-50 bg-zinc-50/20 flex items-center justify-between" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="text-[12px] font-black text-zinc-900"${_scopeId2}>${ssrInterpolate(__props.price)}</div>`);
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(_sfc_main$3), {
                          ...
                          variant: "ghost",
                          size: "sm",
                          class: "h-7 text-[10px] font-black hover:bg-zinc-900 hover:text-white rounded-md px-3 transition-all"
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`${ssrInterpolate(__props.isEnrolled ? "دخلت" : "التفاصيل")}`);
                            } else {
                              return [
                                createTextVNode(toDisplayString(__props.isEnrolled ? "دخلت" : "التفاصيل"), 1)
                              ];
                            }
                          }),
                          _: 1
                  ...
                  return [
                    createVNode("div", { class: "text-[12px] font-black text-zinc-900" }, toDisplayString(__props.price), 1),
            ...
            return [
              ...
              createVNode(unref(_sfc_main$7), { class: "p-3 pt-0 mt-auto border-t border-zinc-50 bg-zinc-50/20 flex items-center justify-between" }, {
                default: withCtx(() => [
                  createVNode("div", { class: "text-[12px] font-black text-zinc-900" }, toDisplayString(__props.price), 1),
                  createVNode(unref(Link), {
                    href: _ctx.route("courses.show", { slug: props.slug }),
