...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="flex-1 flex flex-col min-w-0 overflow-hidden relative z-10"><header class="h-11 shrink-0 bg-[var(--card)] border-b border-[var(--border)] sticky top-0 z-40 flex items-center justify-between px-4 lg:px-6 shadow-none"><div class="flex items-center gap-3"><button class="lg:hidden p-1.5 rounded">`);
