...
import { ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderStyle, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain } from "vue/server-renderer";
...
import { ChevronLeft, Save, Settings, Plus, Trash2, Video, FileText, Link as Link$1, X, HelpCircle } from "lucide-vue-next";
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span class="text-zinc-900 font-bold tracking-tight"${_scopeId}>${ssrInterpolate(__props.lesson ? "تعديل الدرس" : "إضافة دروس جديدة")}</span></div><div class="flex items-center gap-2"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("teacher.courses.edit", __props.course.id)
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$2), {
              ...
              class: "h-7 text-[11px] px-6 font-bold shadow-sm relative overflow-hidden"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (unref(form).processing) {
                    _push3(`<div class="absolute inset-0 flex items-center justify-center bg-zinc-900"${_scopeId2}><span class="text-[10px]"${_scopeId2}>${ssrInterpolate(unref(form).progress ? unref(form).progress.percentage + "%" : "جاري الحفظ...")}</span><div class="absolute bottom-0 left-0 h-1 bg-emerald-500 transition-all duration-300" style="${ssrRenderStyle({ width: (unref(form).progress ? unref(form).progress.percentage : 100) + "%" })}"${_scopeId2}></div></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
                  return [
                    ...
                    unref(form).processing ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("div", {
                        class: "absolute bottom-0 left-0 h-1 bg-emerald-500 transition-all duration-300",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$6), { class: "p-3 space-y-3" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="p-2.5 rounded-lg border border-zinc-100 bg-zinc-50/50 text-zinc-400 font-bold text-[10px] leading-relaxed"${_scopeId3}> يمكنك إضافة عدة دروس في طلب واحد. سيتم تخزينها بالترتيب الموضح أدناه. </div>`);
                        _push4(ssrRenderComponent(unref(_sfc_main$2), {
                          type: "button",
                          variant: "outline",
                          onClick: addLesson,
                          class: "w-full h-8 text-[11px] font-black border-dashed border-zinc-300 hover:border-zinc-900 transition-all"
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(Plus), { class: "ml-1.5 h-3.5 w-3.5" }, null, _parent5, _scopeId4));
                              _push5(` إضافة درس آخر للقائمة `);
                            } else {
                              return [
                                createVNode(unref(Plus), { class: "ml-1.5 h-3.5 w-3.5" }),
                        ...
                        return [
                          createVNode("div", { class: "p-2.5 rounded-lg border border-zinc-100 bg-zinc-50/50 text-zinc-400 font-bold text-[10px] leading-relaxed" }, " يمكنك إضافة عدة دروس في طلب واحد. سيتم تخزينها بالترتيب الموضح أدناه. "),
                          createVNode(unref(_sfc_main$2), {
                            type: "button",
                            variant: "outline",
                            onClick: addLesson,
            ...
            ssrRenderList(unref(form).lessons, (lessonItem, lIdx) => {
              ...
              _push2(ssrRenderComponent(unref(_sfc_main$3), { class: "border-zinc-200 shadow-none rounded-md overflow-hidden bg-white" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(unref(_sfc_main$4), { class: "p-3 bg-zinc-50/30 flex flex-row items-center justify-between border-b border-zinc-100 space-y-0" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="flex items-center gap-2.5 flex-1"${_scopeId3}>`);
                          _push4(ssrRenderComponent(unref(_sfc_main$7), {
                            variant: "outline",
                            class: "h-5 min-w-[20px] rounded bg-zinc-900 text-white font-black text-[10px] p-0 flex items-center justify-center border-none shadow-sm"
                          }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                          ...
                          _push4(ssrRenderComponent(unref(_sfc_main$8), {
                            ...
                            class: "border-none shadow-none focus-visible:ring-0 text-[13px] font-bold bg-transparent p-0 h-auto placeholder:text-zinc-300"
                          ...
                          if (unref(form).lessons.length > 1) {
                            _push4(ssrRenderComponent(unref(_sfc_main$2), {
                              ...
                              class: "h-7 w-7 text-zinc-300 hover:text-red-500"
                            }, {
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                    ...
                    _push3(ssrRenderComponent(unref(_sfc_main$6), { class: "p-4 space-y-6" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="grid grid-cols-1 md:grid-cols-2 gap-4"${_scopeId3}><div class="space-y-1.5"${_scopeId3}>`);
                          _push4(ssrRenderComponent(unref(_sfc_main$9), { class: "text-[11px] font-bold text-zinc-400" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`ملف الفيديو`);
                              } else {
                          ...
                          _push4(ssrRenderComponent(unref(_sfc_main$8), {
                            ...
                            class: "h-8.5 text-[12px] border-zinc-100 bg-zinc-50/20 file:bg-zinc-900 file:text-white file:border-0 file:rounded file:px-3 file:py-1 file:mr-2 file:text-[10px] file:font-bold cursor-pointer"
                          }, null, _parent4, _scopeId3));
                          if (lessonItem.video_url) {
                            _push4(`<p class="text-[10px] text-emerald-600 mt-1 font-bold flex items-center gap-1"${_scopeId3}>`);
                          ...
                          _push4(ssrRenderComponent(unref(_sfc_main$8), {
                            ...
                            class: "h-8.5 text-[12px] font-bold text-center border-zinc-100"
                          }, null, _parent4, _scopeId3));
                          _push4(`</div></div><div class="space-y-1.5"${_scopeId3}><div class="flex items-center justify-between"${_scopeId3}>`);
                          _push4(ssrRenderComponent(unref(_sfc_main$9), { class: "text-[11px] font-bold text-zinc-400 uppercase tracking-widest flex items-center gap-1.5" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                          ...
                          _push4(`<div class="flex items-center gap-1.5 px-2 py-0.5 rounded bg-zinc-50 border border-zinc-100"${_scopeId3}><input type="checkbox"${ssrRenderAttr("id", "preview-" + lIdx)}${ssrIncludeBooleanAttr(Array.isArray(lessonItem.is_preview) ? ssrLooseContain(lessonItem.is_preview, null) : lessonItem.is_preview) ? " checked" : ""} class="h-3 w-3 rounded text-zinc-900 border-zinc-300"${_scopeId3}>`);
                          _push4(ssrRenderComponent(unref(_sfc_main$9), {
                            for: "preview-" + lIdx,
                            class: "text-[10px] font-bold text-zinc-400 cursor-pointer"
                          }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                          ...
                          _push4(`</div></div><textarea rows="6" class="w-full min-h-[120px] rounded-md border border-zinc-100 p-3 text-[12px] font-medium outline-none focus:ring-1 focus:ring-zinc-900 shadow-inner bg-zinc-50/10" placeholder="اشرح محتوى الدرس أو أضف روابط خارجية..."${_scopeId3}>${ssrInterpolate(lessonItem.content)}</textarea></div><div class="grid grid-cols-1 xl:grid-cols-2 gap-6"${_scopeId3}><div class="space-y-3"${_scopeId3}><div class="flex items-center justify-between border-b border-zinc-50 pb-1"${_scopeId3}>`);
                          _push4(ssrRenderComponent(unref(_sfc_main$9), { class: "text-[11px] font-black text-zinc-400 uppercase tracking-[0.2em] flex items-center gap-1.5" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(unref(Link$1), { class: "h-3 w-3" }, null, _parent5, _scopeId4));
                                _push5(` المصادر `);
                              } else {
                                return [
                                  createVNode(unref(Link$1), { class: "h-3 w-3" }),
                          ...
                          _push4(ssrRenderComponent(unref(_sfc_main$2), {
                            ...
                            class: "h-6 text-[9px] font-black text-emerald-600 hover:bg-emerald-50"
                          }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(` + إضافة `);
                          ...
                          ssrRenderList(lessonItem.resources, (res, rIdx) => {
                            _push4(`<div class="flex items-center gap-2 p-1.5 bg-zinc-50/50 rounded-md group/res"${_scopeId3}>`);
                            _push4(ssrRenderComponent(unref(_sfc_main$8), {
                              modelValue: res.title,
                              "onUpdate:modelValue": ($event) => res.title = $event,
                              placeholder: "الاسم",
                              class: "h-7 text-[11px] flex-1 bg-white border-zinc-100 shadow-none"
                            }, null, _parent4, _scopeId3));
                            _push4(ssrRenderComponent(unref(_sfc_main$8), {
                              modelValue: res.url,
                            ...
                            _push4(ssrRenderComponent(unref(_sfc_main$2), {
                              ...
                              variant: "ghost",
                              size: "icon",
                              class: "h-7 w-7 text-zinc-200 hover:text-red-500"
                            }, {
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                          ...
                          if (lessonItem.resources.length === 0) {
                            _push4(`<div class="text-center py-4 border border-dashed border-zinc-100 rounded-md text-[10px] text-zinc-300 italic"${_scopeId3}> لا توجد ملفات مرفقة. </div>`);
                          } else {
                            _push4(`<!---->`);
                          }
                          _push4(`</div></div><div class="space-y-3"${_scopeId3}><div class="flex items-center justify-between border-b border-zinc-50 pb-1"${_scopeId3}>`);
                          _push4(ssrRenderComponent(unref(_sfc_main$9), { class: "text-[11px] font-black text-zinc-400 uppercase tracking-[0.2em] flex items-center gap-1.5" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(unref(HelpCircle), { class: "h-3 w-3" }, null, _parent5, _scopeId4));
                          ...
                          ssrRenderList(lessonItem.faqs, (faq, fIdx) => {
                            _push4(`<div class="p-2 bg-zinc-50/50 rounded-md border border-zinc-100 space-y-2 relative group/faq text-right"${_scopeId3}>`);
                            _push4(ssrRenderComponent(unref(_sfc_main$8), {
                              modelValue: faq.q,
                              "onUpdate:modelValue": ($event) => faq.q = $event,
                              placeholder: "السؤال",
                              class: "h-7 text-[11px] font-bold bg-white border-none shadow-sm"
                            }, null, _parent4, _scopeId3));
                            _push4(`<textarea rows="2" class="w-full p-2 rounded bg-white border border-zinc-50 text-[11px] min-h-[40px] outline-none shadow-sm" placeholder="الإجابة..."${_scopeId3}>${ssrInterpolate(faq.a)}</textarea>`);
                            _push4(ssrRenderComponent(unref(_sfc_main$2), {
                              onClick: ($event) => removeFaq(lIdx, fIdx),
                              variant: "ghost",
                              size: "icon",
                              class: "absolute top-1 left-1 h-6 w-6 text-zinc-200 hover:text-red-500 opacity-0 group-hover/faq:opacity-100 transition-opacity"
                            }, {
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                          ...
                          if (lessonItem.faqs.length === 0) {
                            _push4(`<div class="text-center py-4 border border-dashed border-zinc-100 rounded-md text-[10px] text-zinc-300 italic"${_scopeId3}> لم تضف أي أسئلة لهذا الدرس. </div>`);
                          } else {
                            _push4(`<!---->`);
                          }
                          _push4(`</div></div></div>`);
                          ...
                          return [
                            createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-4" }, [
                              createVNode("div", { class: "space-y-1.5" }, [
                                createVNode(unref(_sfc_main$9), { class: "text-[11px] font-bold text-zinc-400" }, {
                                  default: withCtx(() => [
                                    createTextVNode("ملف الفيديو")
                                  ]),
                                  _: 1
                                ...
                                createVNode("div", { class: "relative" }, [
                                  ...
                                  lessonItem.video_url ? (openBlock(), createBlock("p", {
                                    key: 0,
                                    class: "text-[10px] text-emerald-600 mt-1 font-bold flex items-center gap-1"
                                  }, [
                            ...
                            createVNode("div", { class: "space-y-1.5" }, [
                              createVNode("div", { class: "flex items-center justify-between" }, [
                                createVNode(unref(_sfc_main$9), { class: "text-[11px] font-bold text-zinc-400 uppercase tracking-widest flex items-center gap-1.5" }, {
                                  default: withCtx(() => [
                                    createVNode(unref(FileText), { class: "h-3 w-3" }),
                                    createTextVNode(" محتوى الدرس وملاحظات للطالب ")
                                  ]),
                                ...
                                createVNode("div", { class: "flex items-center gap-1.5 px-2 py-0.5 rounded bg-zinc-50 border border-zinc-100" }, [
                                  withDirectives(createVNode("input", {
                                    type: "checkbox",
                                    id: "preview-" + lIdx,
                                    "onUpdate:modelValue": ($event) => lessonItem.is_preview = $event,
                                    class: "h-3 w-3 rounded text-zinc-900 border-zinc-300"
                              ...
                              withDirectives(createVNode("textarea", {
                                ...
                                rows: "6",
                                class: "w-full min-h-[120px] rounded-md border border-zinc-100 p-3 text-[12px] font-medium outline-none focus:ring-1 focus:ring-zinc-900 shadow-inner bg-zinc-50/10",
                            ...
                            createVNode("div", { class: "grid grid-cols-1 xl:grid-cols-2 gap-6" }, [
                              createVNode("div", { class: "space-y-3" }, [
                                createVNode("div", { class: "flex items-center justify-between border-b border-zinc-50 pb-1" }, [
                                  createVNode(unref(_sfc_main$9), { class: "text-[11px] font-black text-zinc-400 uppercase tracking-[0.2em] flex items-center gap-1.5" }, {
                                    default: withCtx(() => [
                                      createVNode(unref(Link$1), { class: "h-3 w-3" }),
                                      createTextVNode(" المصادر ")
                                    ]),
                                ...
                                createVNode("div", { class: "space-y-1.5" }, [
                                  (openBlock(true), createBlock(Fragment, null, renderList(lessonItem.resources, (res, rIdx) => {
                                    return openBlock(), createBlock("div", {
                                      key: rIdx,
                                      class: "flex items-center gap-2 p-1.5 bg-zinc-50/50 rounded-md group/res"
                                    }, [
                                      createVNode(unref(_sfc_main$8), {
                                        modelValue: res.title,
                                        "onUpdate:modelValue": ($event) => res.title = $event,
                                  ...
                                  lessonItem.resources.length === 0 ? (openBlock(), createBlock("div", {
                                    key: 0,
                                    class: "text-center py-4 border border-dashed border-zinc-100 rounded-md text-[10px] text-zinc-300 italic"
                              ...
                              createVNode("div", { class: "space-y-3" }, [
                                ...
                                createVNode("div", { class: "space-y-2" }, [
                                  (openBlock(true), createBlock(Fragment, null, renderList(lessonItem.faqs, (faq, fIdx) => {
                                    return openBlock(), createBlock("div", {
                                      key: fIdx,
                                      class: "p-2 bg-zinc-50/50 rounded-md border border-zinc-100 space-y-2 relative group/faq text-right"
                                    }, [
                                      createVNode(unref(_sfc_main$8), {
                                        modelValue: faq.q,
                                        "onUpdate:modelValue": ($event) => faq.q = $event,
                                      ...
                                      withDirectives(createVNode("textarea", {
                                        ...
                                        rows: "2",
                                        class: "w-full p-2 rounded bg-white border border-zinc-50 text-[11px] min-h-[40px] outline-none shadow-sm",
                                        placeholder: "الإجابة..."
                                      }, null, 8, ["onUpdate:modelValue"]), [
                                        [vModelText, faq.a]
                                      ]),
                    ...
                    return [
                      createVNode(unref(_sfc_main$4), { class: "p-3 bg-zinc-50/30 flex flex-row items-center justify-between border-b border-zinc-100 space-y-0" }, {
                        default: withCtx(() => [
                          createVNode("div", { class: "flex items-center gap-2.5 flex-1" }, [
                            createVNode(unref(_sfc_main$7), {
                              variant: "outline",
                      ...
                      createVNode(unref(_sfc_main$6), { class: "p-4 space-y-6" }, {
                        default: withCtx(() => [
                          createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-4" }, [
                            createVNode("div", { class: "space-y-1.5" }, [
                              createVNode(unref(_sfc_main$9), { class: "text-[11px] font-bold text-zinc-400" }, {
              ...
              createVNode("div", { class: "flex flex-col h-full bg-zinc-50/20 text-[12px]" }, [
                createVNode("header", { class: "h-11 border-b bg-white flex items-center justify-between px-4 sticky top-0 z-30 shadow-sm" }, [
                  createVNode("div", { class: "flex items-center gap-2 text-[11px] text-muted-foreground font-medium uppercase tracking-tight" }, [
                    ...
                    createVNode("span", { class: "text-zinc-900 font-bold tracking-tight" }, toDisplayString(__props.lesson ? "تعديل الدرس" : "إضافة دروس جديدة"), 1)
                  ]),
