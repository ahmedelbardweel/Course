      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="mb-6 text-center sm:text-right"${_scopeId}><h1 class="text-2xl font-bold tracking-tight text-zinc-950"${_scopeId}>تأكيد الهوية</h1><p class="text-[13px] text-zinc-500 mt-1.5 leading-relaxed"${_scopeId}> هذه منطقة آمنة من التطبيق. يرجى تأكيد كلمة المرور الخاصة بك للمتابعة. </p></div><form class="space-y-5"${_scopeId}><div class="space-y-2"${_scopeId}>`);
            ...
            return [
              ...
              createVNode("div", { class: "mb-6 text-center sm:text-right" }, [
                createVNode("h1", { class: "text-2xl font-bold tracking-tight text-zinc-950" }, "تأكيد الهوية"),
                createVNode("p", { class: "text-[13px] text-zinc-500 mt-1.5 leading-relaxed" }, " هذه منطقة آمنة من التطبيق. يرجى تأكيد كلمة المرور الخاصة بك للمتابعة. ")
              ]),
              createVNode("form", {
