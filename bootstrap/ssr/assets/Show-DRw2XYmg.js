import { mergeProps, unref, useSSRContext, ref, computed, onMounted, withCtx, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, createCommentVNode, Fragment, renderList, withModifiers, withDirectives, withKeys, vModelText } from "vue";
...
import { _ as _sfc_main$2 } from "./AuthenticatedLayout-DnWC7g1W.js";
...
import { Loader2, Clock, BookOpen, Award, ArrowUpRight, Play, PlayCircle, Lock, Briefcase, Sparkles, CheckCircle2, Trash2, Check, BrainCircuit, X, Send } from "lucide-vue-next";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (!__props.course) {
              _push2(`<div class="min-h-[60vh] flex flex-col items-center justify-center gap-4 text-[var(--muted-foreground)]" data-v-f437f270${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Loader2), { class: "h-6 w-6 animate-spin" }, null, _parent2, _scopeId));
              _push2(`<p class="font-normal text-sm" data-v-f437f270${_scopeId}>جاري تحميل البيانات...</p></div>`);
            } else if (!__props.isEnrolled) {
              _push2(`<div class="w-full max-w-5xl mx-auto p-4 md:p-8 space-y-8 bg-[var(--card)] border border-[var(--border)] rounded-md mt-4 shadow-none" data-v-f437f270${_scopeId}><div class="flex flex-col md:flex-row gap-8 items-start" data-v-f437f270${_scopeId}><div class="flex-1 space-y-6" data-v-f437f270${_scopeId}><div data-v-f437f270${_scopeId}>`);
              ...
              _push2(`<h1 class="text-3xl font-normal tracking-tight text-[var(--foreground)]" data-v-f437f270${_scopeId}>${ssrInterpolate(__props.course.title)}</h1><p class="text-xs text-[var(--muted-foreground)] mt-4 leading-relaxed" data-v-f437f270${_scopeId}>${ssrInterpolate(__props.course.description)}</p></div><div class="flex flex-wrap items-center gap-4 text-[11px] text-[var(--muted-foreground)] font-normal" data-v-f437f270${_scopeId}><div class="flex items-center gap-1.5" data-v-f437f270${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Clock), { class: "h-4 w-4" }, null, _parent2, _scopeId));
              _push2(`<span data-v-f437f270${_scopeId}>${ssrInterpolate(totalDuration.value)} دقيقة</span></div>`);
              _push2(ssrRenderComponent(unref(_sfc_main$4), {
                orientation: "vertical",
                class: "h-4"
              }, null, _parent2, _scopeId));
              _push2(`<div class="flex items-center gap-1.5" data-v-f437f270${_scopeId}>`);
              _push2(ssrRenderComponent(unref(BookOpen), { class: "h-4 w-4" }, null, _parent2, _scopeId));
              _push2(`<span data-v-f437f270${_scopeId}>${ssrInterpolate(((_a2 = __props.course.lessons) == null ? void 0 : _a2.length) || 0)} درس</span></div>`);
              _push2(ssrRenderComponent(unref(_sfc_main$4), {
                orientation: "vertical",
                class: "h-4"
              }, null, _parent2, _scopeId));
              ...
              _push2(`<span data-v-f437f270${_scopeId}>${ssrInterpolate(__props.course.level || "جميع المستويات")}</span></div></div><div class="pt-4" data-v-f437f270${_scopeId}>`);
              ...
              _push2(`</div></div><div class="w-full md:w-1/2" data-v-f437f270${_scopeId}>`);
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (__props.course.thumbnail) {
                      _push3(`<img${ssrRenderAttr("src", __props.course.thumbnail)} class="absolute inset-0 w-full h-full object-cover" data-v-f437f270${_scopeId2}>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<div class="relative z-10 h-11 w-11 bg-[var(--card)] border border-[var(--border)] rounded-md flex items-center justify-center shadow-none" data-v-f437f270${_scopeId2}>`);
              ...
              _push2(`</div></div><div class="space-y-6 pt-8 border-t border-[var(--border)]" data-v-f437f270${_scopeId}><div data-v-f437f270${_scopeId}><h2 class="text-base font-normal tracking-tight mb-1 text-[var(--foreground)]" data-v-f437f270${_scopeId}>منهج الدورة</h2><p class="text-xs text-[var(--muted-foreground)]" data-v-f437f270${_scopeId}>تعرف على المحتوى الذي ستدرسه في هذه الدورة.</p></div><div class="grid gap-3" data-v-f437f270${_scopeId}><!--[-->`);
              ssrRenderList(__props.course.lessons, (lesson, index) => {
                _push2(ssrRenderComponent(unref(_sfc_main$6), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="flex items-center gap-4" data-v-f437f270${_scopeId2}><span class="text-xs font-normal text-[var(--muted-foreground)] w-6" data-v-f437f270${_scopeId2}>${ssrInterpolate(index + 1)}</span><div class="flex flex-col" data-v-f437f270${_scopeId2}><span class="font-normal text-xs text-[var(--foreground)]" data-v-f437f270${_scopeId2}>${ssrInterpolate(lesson.title)}</span><span class="text-[10px] text-[var(--muted-foreground)] flex items-center gap-1 mt-1" data-v-f437f270${_scopeId2}>`);
              ...
              _push2(`<div class="max-w-7xl mx-auto p-4 md:p-6" data-v-f437f270${_scopeId}><div class="flex flex-col lg:flex-row gap-6 items-start" data-v-f437f270${_scopeId}><div class="flex-1 min-w-0 space-y-6 w-full order-2 lg:order-1" data-v-f437f270${_scopeId}>`);
              _push2(ssrRenderComponent(unref(_sfc_main$6), { class: "overflow-hidden shadow-none border border-[var(--border)] bg-black rounded-md" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="relative w-full aspect-video" data-v-f437f270${_scopeId2}>`);
                    if (__props.currentLesson) {
                      _push3(`<iframe${ssrRenderAttr("src", __props.currentLesson.video_url)} class="absolute inset-0 w-full h-full border-0" allowfullscreen data-v-f437f270${_scopeId2}></iframe>`);
                    } else {
                      _push3(`<div class="absolute inset-0 flex items-center justify-center text-white/50 flex-col gap-2" data-v-f437f270${_scopeId2}>`);
                      _push3(ssrRenderComponent(unref(PlayCircle), { class: "h-10 w-10 opacity-50" }, null, _parent3, _scopeId2));
                      _push3(`<span class="text-xs font-normal" data-v-f437f270${_scopeId2}>اختر درساً</span></div>`);
                    }
                    _push3(`</div>`);
                  } else {
                    return [
              ...
              _push2(`<div class="flex flex-col md:flex-row md:items-center justify-between gap-4" data-v-f437f270${_scopeId}><div class="space-y-1" data-v-f437f270${_scopeId}><h2 class="text-xl font-normal tracking-tight text-[var(--foreground)]" data-v-f437f270${_scopeId}>${ssrInterpolate(((_b2 = __props.currentLesson) == null ? void 0 : _b2.title) || "مرحباً بك")}</h2><p class="text-xs text-[var(--muted-foreground)]" data-v-f437f270${_scopeId}>${ssrInterpolate(__props.course.title)}</p></div>`);
              if (__props.currentLesson) {
                _push2(`<div class="flex flex-wrap items-center gap-2" data-v-f437f270${_scopeId}>`);
              ...
              if (summaryResult.value) {
                _push2(`<div class="p-5 bg-[var(--muted)] border border-[var(--border)] rounded-md" data-v-f437f270${_scopeId}><div class="flex items-center gap-2 mb-3" data-v-f437f270${_scopeId}>`);
                _push2(ssrRenderComponent(unref(Sparkles), { class: "h-4 w-4 text-[var(--primary)]" }, null, _parent2, _scopeId));
                _push2(`<h3 class="font-normal text-xs text-[var(--foreground)]" data-v-f437f270${_scopeId}>التلخيص</h3></div><div class="prose prose-sm max-w-none text-[var(--muted-foreground)] leading-relaxed text-xs" data-v-f437f270${_scopeId}>${summaryResult.value ?? ""}</div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="space-y-4" data-v-f437f270${_scopeId}><div class="border-b border-[var(--border)] flex items-center gap-6" data-v-f437f270${_scopeId}><!--[-->`);
              ssrRenderList([
                ...
                ])}" data-v-f437f270${_scopeId}>${ssrInterpolate(tab.label)}</button>`);
              });
              _push2(`<!--]--></div><div class="py-2" data-v-f437f270${_scopeId}>`);
              if (activeTab.value === "overview") {
                _push2(`<div class="text-xs text-[var(--muted-foreground)] leading-relaxed" data-v-f437f270${_scopeId}>${ssrInterpolate(__props.course.description)}</div>`);
              } else {
                _push2(`<!---->`);
              }
              if (activeTab.value === "notes") {
                _push2(`<div class="space-y-6" data-v-f437f270${_scopeId}><div class="grid gap-2" data-v-f437f270${_scopeId}>`);
                ...
                _push2(`<div class="flex justify-end" data-v-f437f270${_scopeId}>`);
                _push2(ssrRenderComponent(unref(_sfc_main$5), {
                  onClick: saveNote,
                ...
                _push2(`</div></div><div class="space-y-3" data-v-f437f270${_scopeId}>`);
                if (isFetchingNotes.value) {
                  _push2(`<div class="py-8 flex justify-center" data-v-f437f270${_scopeId}>`);
                  ...
                  _push2(`<div class="py-8 text-center text-xs text-[var(--muted-foreground)] font-normal" data-v-f437f270${_scopeId}>لا توجد ملاحظات.</div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<!--[-->`);
                ssrRenderList(notes.value, (note) => {
                  _push2(ssrRenderComponent(unref(_sfc_main$6), {
                    ...
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        _push3(`<button class="absolute top-4 end-4 text-[var(--muted-foreground)]" data-v-f437f270${_scopeId2}>`);
                        _push3(ssrRenderComponent(unref(Trash2), { class: "h-3.5 w-3.5" }, null, _parent3, _scopeId2));
                        _push3(`</button><p class="text-xs text-[var(--foreground)] whitespace-pre-wrap pe-8 leading-relaxed" data-v-f437f270${_scopeId2}>${ssrInterpolate(note.content)}</p><span class="text-[10px] text-[var(--muted-foreground)] mt-3 block font-normal" data-v-f437f270${_scopeId2}>${ssrInterpolate(new Date(note.created_at).toLocaleDateString("ar-SA"))}</span>`);
                      } else {
                        return [
                          createVNode("button", {
              ...
              if (activeTab.value === "challenges") {
                _push2(`<div data-v-f437f270${_scopeId}>`);
                if (((_c = __props.course.challenges) == null ? void 0 : _c.length) === 0) {
                  _push2(`<div class="py-8 text-center text-xs text-[var(--muted-foreground)] font-normal" data-v-f437f270${_scopeId}>لا توجد تحديات.</div>`);
                } else {
                  _push2(`<div class="grid sm:grid-cols-2 gap-4" data-v-f437f270${_scopeId}><!--[-->`);
                  ssrRenderList(__props.course.challenges, (challenge) => {
                    _push2(ssrRenderComponent(unref(_sfc_main$6), {
                      ...
                      default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                        if (_push3) {
                          _push3(`<div class="flex items-start justify-between mb-2" data-v-f437f270${_scopeId2}><h4 class="font-normal text-sm text-[var(--foreground)]" data-v-f437f270${_scopeId2}>${ssrInterpolate(challenge.title)}</h4>`);
                          ...
                          _push3(`</div><p class="text-xs text-[var(--muted-foreground)] mb-6 flex-1 leading-relaxed" data-v-f437f270${_scopeId2}>${ssrInterpolate(challenge.description)}</p>`);
                          _push3(ssrRenderComponent(unref(_sfc_main$5), {
              ...
              if (activeTab.value === "quizzes") {
                ...
                if (((_d = __props.course.quizzes) == null ? void 0 : _d.length) === 0) {
                  _push2(`<div class="py-8 text-center text-xs text-[var(--muted-foreground)] font-normal" data-v-f437f270${_scopeId}>لا توجد اختبارات.</div>`);
                } else {
                  _push2(`<div class="grid sm:grid-cols-2 gap-4" data-v-f437f270${_scopeId}><!--[-->`);
                  ssrRenderList(__props.course.quizzes, (quiz) => {
                    _push2(ssrRenderComponent(unref(_sfc_main$6), {
                      ...
                      default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                        if (_push3) {
                          _push3(`<h4 class="font-normal text-sm text-[var(--foreground)] mb-1.5" data-v-f437f270${_scopeId2}>${ssrInterpolate(quiz.title)}</h4><p class="text-xs text-[var(--muted-foreground)] mb-6 flex-1 leading-relaxed" data-v-f437f270${_scopeId2}>${ssrInterpolate(quiz.description)}</p><div class="flex items-center gap-2 mb-4 text-[10px] text-[var(--muted-foreground)] font-normal" data-v-f437f270${_scopeId2}><span data-v-f437f270${_scopeId2}>${ssrInterpolate(quiz.questions_count || 0)} أسئلة</span>`);
                          _push3(ssrRenderComponent(unref(_sfc_main$4), {
                            orientation: "vertical",
                            class: "h-3"
                          }, null, _parent3, _scopeId2));
                          _push3(`<span data-v-f437f270${_scopeId2}>نجاح: ${ssrInterpolate(quiz.passing_score)}%</span></div>`);
              ...
              _push2(`</div></div></div><div class="w-full lg:w-[320px] shrink-0 space-y-4 order-1 lg:order-2" data-v-f437f270${_scopeId}>`);
              _push2(ssrRenderComponent(unref(_sfc_main$6), { class: "shadow-none border border-[var(--border)] flex flex-col h-auto lg:max-h-[calc(100vh-8rem)] lg:sticky lg:top-24 bg-[var(--card)] rounded-md overflow-hidden" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  ...
                  if (_push3) {
                    _push3(`<div class="p-4 border-b border-[var(--border)] bg-[var(--muted)]" data-v-f437f270${_scopeId2}><h3 class="font-normal text-xs mb-3 text-[var(--foreground)]" data-v-f437f270${_scopeId2}>محتوى الكورس</h3><div class="flex items-center justify-between text-[11px] text-[var(--muted-foreground)] font-normal" data-v-f437f270${_scopeId2}><span data-v-f437f270${_scopeId2}>المكتمل: ${ssrInterpolate(__props.completedLessonsIds.length)}/${ssrInterpolate(((_a3 = __props.course.lessons) == null ? void 0 : _a3.length) || 0)}</span><span data-v-f437f270${_scopeId2}>${ssrInterpolate(Math.round(__props.completedLessonsIds.length / (((_b3 = __props.course.lessons) == null ? void 0 : _b3.length) || 1) * 100))}%</span></div><div class="w-full h-2 bg-[var(--accent)] border border-[var(--border)] rounded-md mt-2 overflow-hidden" data-v-f437f270${_scopeId2}><div class="h-full bg-[var(--primary)]" style="${ssrRenderStyle({ width: `${__props.completedLessonsIds.length / (((_c2 = __props.course.lessons) == null ? void 0 : _c2.length) || 1) * 100}%` })}" data-v-f437f270${_scopeId2}></div></div></div><div class="flex-1 overflow-y-auto divide-y divide-[var(--border)] text-xs" data-v-f437f270${_scopeId2}><!--[-->`);
                    ssrRenderList(__props.course.lessons, (lesson, index) => {
                      var _a4;
                      _push3(ssrRenderComponent(unref(Link), {
                        key: lesson.id,
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          ...
                          if (_push4) {
                            _push4(`<div class="flex-1 min-w-0" data-v-f437f270${_scopeId3}><span class="${ssrRenderClass(["text-xs line-clamp-2", ((_a5 = __props.currentLesson) == null ? void 0 : _a5.id) === lesson.id ? "text-[var(--foreground)]" : "text-[var(--muted-foreground)]"])}" data-v-f437f270${_scopeId3}>${ssrInterpolate(index + 1)}. ${ssrInterpolate(lesson.title)}</span></div>`);
                            if ((_b4 = __props.completedLessonsIds) == null ? void 0 : _b4.includes(lesson.id)) {
                              ...
                              _push4(`<div class="h-1.5 w-1.5 bg-[var(--primary)] rounded-full shrink-0 mt-1.5 animate-pulse" data-v-f437f270${_scopeId3}></div>`);
                            } else {
                              _push4(`<!---->`);
                            }
                          } else {
              ...
              _push2(ssrRenderComponent(unref(_sfc_main$6), { class: "shadow-none border border-[var(--border)] p-4 bg-[var(--card)] rounded-md" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  var _a3, _b3;
                  if (_push3) {
                    _push3(`<div class="flex items-center gap-3 mb-2" data-v-f437f270${_scopeId2}><div class="h-8 w-8 rounded-md bg-[var(--muted)] border border-[var(--border)] flex items-center justify-center" data-v-f437f270${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(BrainCircuit), { class: "h-4 w-4 text-[var(--primary)]" }, null, _parent3, _scopeId2));
                    _push3(`</div><div data-v-f437f270${_scopeId2}><h4 class="font-normal text-xs text-[var(--foreground)]" data-v-f437f270${_scopeId2}>المساعد الذكي</h4><p class="text-[10px] text-[var(--muted-foreground)]" data-v-f437f270${_scopeId2}>اطرح أسئلة حول الدرس</p></div></div>`);
                    _push3(ssrRenderComponent(unref(Link), {
              ...
              _push2(ssrRenderComponent(unref(_sfc_main$6), { class: "shadow-none border border-[var(--border)] p-4 bg-[var(--card)] rounded-md" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="flex items-center justify-between mb-2" data-v-f437f270${_scopeId2}><div class="flex items-center gap-3" data-v-f437f270${_scopeId2}><div class="h-8 w-8 rounded-md bg-[var(--muted)] border border-[var(--border)] flex items-center justify-center" data-v-f437f270${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(Award), { class: "h-4 w-4 text-[var(--primary)]" }, null, _parent3, _scopeId2));
                    _push3(`</div><div data-v-f437f270${_scopeId2}><h4 class="font-normal text-xs text-[var(--foreground)]" data-v-f437f270${_scopeId2}>غرف المذاكرة</h4><p class="text-[10px] text-[var(--muted-foreground)]" data-v-f437f270${_scopeId2}>للمذاكرة الجماعية</p></div></div><span class="relative flex h-2 w-2" data-v-f437f270${_scopeId2}><span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-[var(--primary)] opacity-75" data-v-f437f270${_scopeId2}></span><span class="relative inline-flex rounded-full h-2 w-2 bg-[var(--primary)]" data-v-f437f270${_scopeId2}></span></span></div>`);
                    _push3(ssrRenderComponent(unref(Link), {
            ...
            if (showInterviewModal.value) {
              _push2(`<div class="fixed inset-0 z-50 flex items-center justify-center p-4" data-v-f437f270${_scopeId}><div class="absolute inset-0 bg-[var(--foreground)]/30 backdrop-blur-sm" data-v-f437f270${_scopeId}></div>`);
              _push2(ssrRenderComponent(unref(_sfc_main$6), { class: "w-full max-w-2xl h-[550px] flex flex-col relative shadow-none border border-[var(--border)] bg-[var(--card)] rounded-md overflow-hidden" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="flex items-center justify-between p-4 border-b border-[var(--border)]" data-v-f437f270${_scopeId2}><div class="flex items-center gap-3" data-v-f437f270${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(Briefcase), { class: "h-4 w-4 text-[var(--primary)]" }, null, _parent3, _scopeId2));
                    _push3(`<h3 class="font-normal text-sm text-[var(--foreground)]" data-v-f437f270${_scopeId2}>تدريب المقابلة الشخصية</h3></div>`);
                    _push3(ssrRenderComponent(unref(_sfc_main$5), {
                      variant: "ghost",
                      size: "icon",
                    ...
                    _push3(`</div><div class="flex-1 overflow-y-auto p-4 space-y-4 bg-[var(--background)]" data-v-f437f270${_scopeId2}><!--[-->`);
                    ssrRenderList(interviewHistory.value, (msg, idx) => {
                      _push3(`<div class="${ssrRenderClass(["flex", msg.role === "user" ? "justify-start" : "justify-end"])}" data-v-f437f270${_scopeId2}><div class="${ssrRenderClass([
                      ...
                      ])}" data-v-f437f270${_scopeId2}><p class="whitespace-pre-wrap" data-v-f437f270${_scopeId2}>${ssrInterpolate(msg.content)}</p></div></div>`);
                    });
                    _push3(`<!--]-->`);
                    if (isInterviewing.value) {
                      _push3(`<div class="flex justify-end" data-v-f437f270${_scopeId2}><div class="bg-[var(--muted)] border border-[var(--border)] rounded-md p-3 text-xs flex items-center gap-2 text-[var(--muted-foreground)] font-normal" data-v-f437f270${_scopeId2}>`);
                      _push3(ssrRenderComponent(unref(Loader2), { class: "h-3.5 w-3.5 animate-spin" }, null, _parent3, _scopeId2));
                      _push3(` يكتب... </div></div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`</div><div class="p-3 border-t border-[var(--border)] bg-[var(--card)]" data-v-f437f270${_scopeId2}><form class="flex items-center gap-2 bg-[var(--muted)] p-1.5 pl-2 rounded-md border border-[var(--border)] focus-within:border-[var(--primary)]" data-v-f437f270${_scopeId2}><textarea placeholder="أرسل إجابتك هنا..." class="flex-1 bg-transparent border-none focus:ring-0 text-xs text-[var(--foreground)] placeholder-[var(--muted-foreground)] py-1 resize-none h-7 overflow-y-auto"${ssrIncludeBooleanAttr(isInterviewing.value) ? " disabled" : ""} data-v-f437f270${_scopeId2}>${ssrInterpolate(interviewInput.value)}</textarea>`);
                    _push3(ssrRenderComponent(unref(_sfc_main$5), {
                      type: "submit",
                  ...
                  createVNode("div", { class: "flex-1 min-w-0 space-y-6 w-full order-2 lg:order-1" }, [
                    ...
                    summaryResult.value ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "flex items-center gap-2 mb-3" }, [
                        ...
                        createVNode("h3", { class: "font-normal text-xs text-[var(--foreground)]" }, "التلخيص")
                      ]),
                      createVNode("div", {
...
const Show = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f437f270"]]);
export {
  Show as default
};
