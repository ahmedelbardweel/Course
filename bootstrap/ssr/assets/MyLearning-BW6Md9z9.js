          ...
          if (_push2) {
            ...
            if (__props.enrolledCourses.length > 0) {
              ...
              _push2(ssrRenderComponent(unref(_sfc_main$3), { class: "border-zinc-200 shadow-none bg-white rounded-lg p-3 flex items-center gap-3" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="h-8 w-8 rounded bg-zinc-100 text-zinc-900 flex items-center justify-center border border-zinc-200"${_scopeId2}>`);
                    ...
                    return [
                      createVNode("div", { class: "h-8 w-8 rounded bg-zinc-100 text-zinc-900 flex items-center justify-center border border-zinc-200" }, [
            ...
            if (__props.enrolledCourses.length === 0) {
              ...
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(unref(_sfc_main$4), { class: "h-9 text-[11px] font-black px-8 rounded-md bg-zinc-900 text-white hover:bg-zinc-800 transition-all border-none" }, {
                    ...
                    return [
                      createVNode(unref(_sfc_main$4), { class: "h-9 text-[11px] font-black px-8 rounded-md bg-zinc-900 text-white hover:bg-zinc-800 transition-all border-none" }, {
                        default: withCtx(() => [
                          createTextVNode("تصفح الكورسات الآن")
                        ]),
                        _: 1
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      if (course.progress === 100) {
                        _push3(ssrRenderComponent(unref(_sfc_main$2), { class: "h-4 text-[8px] font-black uppercase tracking-widest px-2 bg-zinc-900 text-white border-none shadow-sm" }, {
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              _push4(` مكتمل `);
                        ...
                        _push3(ssrRenderComponent(unref(_sfc_main$2), { class: "h-4 text-[8px] font-black uppercase tracking-widest px-2 bg-white border border-zinc-200 text-zinc-900 shadow-sm" }, {
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              _push4(` قيد التعلم `);
                            } else {
                      ...
                      _push3(ssrRenderComponent(unref(_sfc_main$5), { class: "p-3 space-y-1" }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          ...
                          if (_push4) {
                            ...
                            _push4(ssrRenderComponent(unref(_sfc_main$6), { class: "text-[12px] font-bold text-zinc-900 line-clamp-1 group-hover:underline transition-colors leading-tight" }, {
                            ...
                            return [
                              ...
                              createVNode(unref(_sfc_main$6), { class: "text-[12px] font-bold text-zinc-900 line-clamp-1 group-hover:underline transition-colors leading-tight" }, {
                                default: withCtx(() => [
                                  createTextVNode(toDisplayString(course.title), 1)
                                ]),
                                _: 2
                        ...
                        createVNode("div", { class: "aspect-video relative overflow-hidden bg-zinc-100 border-b border-zinc-50" }, [
                          ...
                          createVNode("div", { class: "absolute top-2 left-2 flex gap-1.5" }, [
                            course.progress === 100 ? (openBlock(), createBlock(unref(_sfc_main$2), {
                              key: 0,
                              class: "h-4 text-[8px] font-black uppercase tracking-widest px-2 bg-zinc-900 text-white border-none shadow-sm"
                            }, {
                              default: withCtx(() => [
                                createTextVNode(" مكتمل "),
                                createVNode(unref(CheckCircle2), { class: "mr-1 h-2.5 w-2.5" })
                              ...
                              key: 1,
                              class: "h-4 text-[8px] font-black uppercase tracking-widest px-2 bg-white border border-zinc-200 text-zinc-900 shadow-sm"
                            }, {
                              default: withCtx(() => [
                                createTextVNode(" قيد التعلم ")
                              ]),
