      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.status) {
              _push2(`<div class="mb-5 text-[12px] font-semibold text-zinc-900 bg-zinc-50 border border-zinc-200 p-3 rounded-md text-center flex items-center justify-center gap-2"${_scopeId}><span class="w-1.5 h-1.5 rounded-full bg-zinc-950"${_scopeId}></span> ${ssrInterpolate(__props.status)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            if (unref(form).errors.email) {
              _push2(`<div class="text-[11px] font-medium text-red-600 flex items-center gap-1.5 mt-1.5"${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$4), {
              class: ["w-full h-10 bg-zinc-950 text-white hover:bg-zinc-900 font-bold rounded-md transition-colors flex items-center justify-center gap-2 border-none shadow-none", { "opacity-80 cursor-not-allowed": unref(form).processing }],
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              class: "inline-flex items-center gap-1.5 text-[11px] font-extrabold text-zinc-950 hover:underline underline-offset-4"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            return [
              ...
              __props.status ? (openBlock(), createBlock("div", {
                ...
                createVNode("span", { class: "w-1.5 h-1.5 rounded-full bg-zinc-950" }),
              ...
              createVNode("form", {
                ...
                createVNode("div", { class: "space-y-1.5" }, [
                  ...
                  unref(form).errors.email ? (openBlock(), createBlock("div", {
                    key: 0,
                    class: "text-[11px] font-medium text-red-600 flex items-center gap-1.5 mt-1.5"
                  }, [
