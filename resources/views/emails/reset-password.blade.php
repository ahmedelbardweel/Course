            ...
            <tr>
                <td>
                    ...
                    <div class="content">
                        ...
                        <!-- Main Title -->
                        <h1 class="title">طلب استعادة كلمة المرور</h1>
                        
                        <!-- Content Text -->
                        <p class="text">
                            لقد تلقينا طلباً لإعادة تعيين كلمة المرور الخاصة بحسابك. يمكنك تعيين كلمة مرور جديدة بالضغط على الزر أدناه:
                        </p>
                        
                        <!-- Action Button -->
                        <div class="button-container">
                            <a href="{{ $url }}" class="btn" target="_blank">تعيين كلمة مرور جديدة</a>
                        </div>
                        
                        <p class="text" style="font-size: 12px; color: #a1a1aa;">
                            * هذا الرابط صالح لمدة 60 دقيقة فقط من وقت الطلب. إذا لم تطلب استعادة كلمة المرور، يمكنك تجاهل هذا البريد الإلكتروني وسيبقى حسابك آمناً.
                        </p>
