      ...
      _push(ssrRenderComponent(_sfc_main$1, { class: "h-full" }, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div${_scopeId}><h2 class="font-black text-sm tracking-tight"${_scopeId}>المدرب الشخصي الذكي</h2><div class="flex items-center gap-1.5"${_scopeId}><span class="h-1.5 w-1.5 bg-green-500 rounded-full animate-pulse"${_scopeId}></span><span class="text-[10px] text-zinc-400 font-bold uppercase tracking-widest"${_scopeId}>متصل وحاضر للمساعدة</span></div></div></div></div><div class="flex-1 overflow-y-auto p-4 space-y-3 scroll-smooth"${_scopeId}><!--[-->`);
            ssrRenderList(messages.value, (msg, index) => {
              _push2(`<div class="${ssrRenderClass(["flex w-full", msg.role === "user" ? "justify-start" : "justify-end"])}"${_scopeId}><div class="${ssrRenderClass([
                ...
                msg.role === "user" ? "bg-zinc-100 text-black rounded-tr-none border border-zinc-200 dark:bg-zinc-800 dark:text-white dark:border-zinc-700" : "bg-white text-black rounded-tl-none border border-zinc-200 dark:bg-zinc-900 dark:text-white dark:border-zinc-800"
                  ...
                  createVNode("div", { class: "flex items-center gap-3" }, [
                    ...
                    createVNode("div", null, [
                      ...
                      createVNode("div", { class: "flex items-center gap-1.5" }, [
                        createVNode("span", { class: "h-1.5 w-1.5 bg-green-500 rounded-full animate-pulse" }),
