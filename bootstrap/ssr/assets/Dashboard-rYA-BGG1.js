      ...
      _push(ssrRenderComponent(_sfc_main$2, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></section><section class="relative bg-zinc-50/30 border-b border-zinc-200 p-6 lg:p-8 overflow-hidden space-y-6"${_scopeId}><div class="absolute inset-0 bg-[radial-gradient(#e4e4e7_1.2px,transparent_1.2px)] [background-size:24px_24px] opacity-40 pointer-events-none"${_scopeId}></div><div class="relative z-10 flex items-center justify-between"${_scopeId}><div${_scopeId}><h2 class="text-[14px] font-black text-zinc-900 flex items-center gap-2"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Folder), { class: "h-4.5 w-4.5 text-zinc-400" }, null, _parent2, _scopeId));
            _push2(` إدارة كورساتك ومناهج الدروس </h2><p class="text-[10px] text-zinc-400 mt-0.5"${_scopeId}>استعراض جميع الكورسات التي أنشأتها وتفاصيل دروسها مباشرة.</p></div><div class="flex items-center gap-3"${_scopeId}>`);
            if (__props.courses.length > 0) {
              ...
              _push2(ssrRenderComponent(unref(_sfc_main$3), {
                ...
                variant: "outline",
                size: "icon",
                class: "h-8 w-8 rounded-full border-zinc-200 bg-white shadow-xs hover:bg-zinc-50 hover:text-zinc-950 transition-all duration-200 active:scale-90"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(unref(ChevronLeft), { class: "h-4 w-4 text-zinc-600" }, null, _parent3, _scopeId2));
                  } else {
                    return [
                      createVNode(unref(ChevronLeft), { class: "h-4 w-4 text-zinc-600" })
                    ];
                  }
                }),
                _: 1
              ...
              _push2(ssrRenderComponent(unref(_sfc_main$3), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(unref(ChevronRight), { class: "h-4 w-4 text-zinc-600" }, null, _parent3, _scopeId2));
                  } else {
                    return [
                      createVNode(unref(ChevronRight), { class: "h-4 w-4 text-zinc-600" })
                    ];
                  }
                }),
                _: 1
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$4), {
              variant: "secondary",
              class: "h-5 text-[9px] font-bold bg-zinc-150 text-zinc-900 border-none px-2 shadow-xs rounded-md"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(`</div></div>`);
            if (__props.courses.length === 0) {
              _push2(`<div class="relative z-10 flex flex-col items-center justify-center py-20 border border-dashed border-zinc-200 bg-white/50 backdrop-blur-sm rounded-xl"${_scopeId}>`);
              ...
              _push2(`<div class="relative z-10 flex gap-6 overflow-x-auto pb-4 pt-1 snap-x snap-mandatory scroll-smooth scrollbar-none"${_scopeId}><!--[-->`);
              ssrRenderList(__props.courses, (course) => {
                _push2(ssrRenderComponent(unref(_sfc_main$5), {
                  key: course.id,
                  class: "w-72 sm:w-80 shrink-0 border-zinc-200/80 shadow-none bg-white hover:border-zinc-400 hover:-translate-y-1 transition-all duration-300 rounded-xl overflow-hidden group flex flex-col snap-start"
                }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    var _a, _b;
                    if (_push3) {
                      _push3(`<div class="aspect-video relative bg-zinc-50 border-b border-zinc-100 overflow-hidden shrink-0"${_scopeId2}>`);
                      if (course.thumbnail) {
                        _push3(`<img${ssrRenderAttr("src", course.thumbnail)} class="w-full h-full object-cover group-hover:scale-[1.03] transition-transform duration-700 ease-out"${_scopeId2}>`);
                      } else {
                      ...
                      _push3(ssrRenderComponent(unref(_sfc_main$4), {
                        ...
                        class: "h-4.5 text-[8px] font-black uppercase tracking-widest px-2 shadow-sm rounded-md"
                      }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                      ...
                      _push3(ssrRenderComponent(unref(_sfc_main$4), {
                        variant: "secondary",
                        class: "h-4.5 text-[8px] font-bold px-2 bg-white/95 backdrop-blur-xs border border-zinc-100/50 text-zinc-900 rounded-md"
                      }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                      ...
                      _push3(`</div></div><div class="p-4 flex-1 flex flex-col justify-between space-y-4"${_scopeId2}><div class="space-y-2"${_scopeId2}><div class="flex items-center justify-between"${_scopeId2}><span class="text-[9px] font-black text-zinc-400 uppercase tracking-widest"${_scopeId2}>${ssrInterpolate(((_a = course.category) == null ? void 0 : _a.name) || "عام")}</span><div class="text-[11px] font-extrabold text-zinc-900 font-sans"${_scopeId2}>${ssrInterpolate(course.price > 0 ? "$" + course.price : "مجاني")}</div></div><h3 class="text-[13px] font-bold text-zinc-900 line-clamp-1 group-hover:text-zinc-950 transition-colors"${_scopeId2}>${ssrInterpolate(course.title)}</h3><p class="text-[10px] text-zinc-400 line-clamp-2 leading-relaxed h-8"${_scopeId2}>${ssrInterpolate(course.description)}</p></div><div class="grid grid-cols-3 gap-1.5 pt-3 border-t border-zinc-50 text-center"${_scopeId2}><div class="flex flex-col items-center justify-center bg-zinc-50/60 p-1.5 rounded-lg border border-zinc-100/80"${_scopeId2}>`);
                      _push3(ssrRenderComponent(unref(Users), { class: "h-3 w-3 text-zinc-400 mb-0.5" }, null, _parent3, _scopeId2));
                      _push3(`<span class="text-[9.5px] text-zinc-850 font-black leading-tight font-sans"${_scopeId2}>${ssrInterpolate(course.users_count || 0)}</span><span class="text-[7.5px] text-zinc-400 leading-none font-bold"${_scopeId2}>طلاب</span></div><div class="flex flex-col items-center justify-center bg-zinc-50/60 p-1.5 rounded-lg border border-zinc-100/80"${_scopeId2}>`);
                      _push3(ssrRenderComponent(unref(PlayCircle), { class: "h-3 w-3 text-zinc-400 mb-0.5" }, null, _parent3, _scopeId2));
                      _push3(`<span class="text-[9.5px] text-zinc-850 font-black leading-tight font-sans"${_scopeId2}>${ssrInterpolate(course.lessons_count || 0)}</span><span class="text-[7.5px] text-zinc-400 leading-none font-bold"${_scopeId2}>دروس</span></div><div class="flex flex-col items-center justify-center bg-zinc-50/60 p-1.5 rounded-lg border border-zinc-100/80"${_scopeId2}>`);
                      _push3(ssrRenderComponent(unref(HelpCircle), { class: "h-3 w-3 text-zinc-400 mb-0.5" }, null, _parent3, _scopeId2));
                      _push3(`<span class="text-[9.5px] text-zinc-850 font-black leading-tight font-sans"${_scopeId2}>${ssrInterpolate(course.quizzes_count || 0)}</span><span class="text-[7.5px] text-zinc-400 leading-none font-bold"${_scopeId2}>اختبارات</span></div></div></div><div class="px-4 pb-4 pt-1 flex items-center justify-between gap-2 border-t border-zinc-50 bg-zinc-50/20"${_scopeId2}>`);
                      ...
                      _push3(ssrRenderComponent(unref(_sfc_main$3), {
                        ...
                        variant: "ghost",
                        size: "sm",
                        class: "h-7 text-[10px] px-3 font-black text-zinc-650 hover:text-zinc-950 rounded-md bg-zinc-50/60 hover:bg-zinc-100/70 transition-all flex items-center gap-1"
                      }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                      ...
                      _push3(`</div>`);
                      if (expandedCourses.value[course.id]) {
                        _push3(`<div class="px-4 pb-4 pt-2.5 border-t border-zinc-100 bg-zinc-50/55 animate-in fade-in slide-in-from-top-2 duration-300"${_scopeId2}><div class="flex items-center gap-1.5 mb-2"${_scopeId2}>`);
                        _push3(ssrRenderComponent(unref(Award), { class: "h-3.5 w-3.5 text-zinc-400" }, null, _parent3, _scopeId2));
                        _push3(`<span class="text-[9px] font-black text-zinc-400 uppercase tracking-widest"${_scopeId2}>منهج الدروس:</span></div>`);
                        if (course.lessons && course.lessons.length > 0) {
                          ...
                          ssrRenderList(course.lessons, (lesson, idx) => {
                            _push3(`<div class="p-2 rounded-lg bg-white border border-zinc-200/50 hover:border-zinc-900/30 transition-all duration-200 flex items-center justify-between group/lesson"${_scopeId2}><div class="flex items-center gap-2 min-w-0"${_scopeId2}><div class="h-4.5 w-4.5 bg-zinc-950 text-white text-[8px] font-black rounded flex items-center justify-center shrink-0 shadow-xs select-none"${_scopeId2}>${ssrInterpolate(idx + 1)}</div><div class="min-w-0"${_scopeId2}><div class="text-[9.5px] font-bold text-zinc-800 line-clamp-1 group-hover/lesson:text-zinc-950 transition-colors"${_scopeId2}>${ssrInterpolate(lesson.title)}</div></div></div>`);
                            _push3(ssrRenderComponent(unref(_sfc_main$4), {
                              variant: "outline",
                              class: "h-4 text-[7px] font-bold bg-zinc-50 border-zinc-150 text-zinc-400 shrink-0"
                            }, {
                              default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                                if (_push4) {
                          ...
                          _push3(ssrRenderComponent(unref(PlayCircle), { class: "h-6 w-6 text-zinc-200 mb-1" }, null, _parent3, _scopeId2));
                          _push3(`<div class="text-[9.5px] font-bold text-zinc-400"${_scopeId2}>لا توجد دروس في الكورس بعد</div>`);
                          _push3(ssrRenderComponent(unref(Link), {
                            href: _ctx.route("teacher.lessons.create", course.id),
                            class: "mt-1 text-[8.5px] font-black text-zinc-950 hover:underline"
                          }, {
                            default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                              if (_push4) {
                                _push4(` + أضف أول درس `);
                      ...
                      return [
                        createVNode("div", { class: "aspect-video relative bg-zinc-50 border-b border-zinc-100 overflow-hidden shrink-0" }, [
                        ...
                        createVNode("div", { class: "p-4 flex-1 flex flex-col justify-between space-y-4" }, [
                          createVNode("div", { class: "space-y-2" }, [
                            createVNode("div", { class: "flex items-center justify-between" }, [
                              ...
                              createVNode("div", { class: "text-[11px] font-extrabold text-zinc-900 font-sans" }, toDisplayString(course.price > 0 ? "$" + course.price : "مجاني"), 1)
                            ]),
                            createVNode("h3", { class: "text-[13px] font-bold text-zinc-900 line-clamp-1 group-hover:text-zinc-950 transition-colors" }, toDisplayString(course.title), 1),
                            createVNode("p", { class: "text-[10px] text-zinc-400 line-clamp-2 leading-relaxed h-8" }, toDisplayString(course.description), 1)
                          ]),
                          createVNode("div", { class: "grid grid-cols-3 gap-1.5 pt-3 border-t border-zinc-50 text-center" }, [
                            createVNode("div", { class: "flex flex-col items-center justify-center bg-zinc-50/60 p-1.5 rounded-lg border border-zinc-100/80" }, [
                              createVNode(unref(Users), { class: "h-3 w-3 text-zinc-400 mb-0.5" }),
                              createVNode("span", { class: "text-[9.5px] text-zinc-850 font-black leading-tight font-sans" }, toDisplayString(course.users_count || 0), 1),
                              createVNode("span", { class: "text-[7.5px] text-zinc-400 leading-none font-bold" }, "طلاب")
                            ]),
                            createVNode("div", { class: "flex flex-col items-center justify-center bg-zinc-50/60 p-1.5 rounded-lg border border-zinc-100/80" }, [
                              createVNode(unref(PlayCircle), { class: "h-3 w-3 text-zinc-400 mb-0.5" }),
                              createVNode("span", { class: "text-[9.5px] text-zinc-850 font-black leading-tight font-sans" }, toDisplayString(course.lessons_count || 0), 1),
                              createVNode("span", { class: "text-[7.5px] text-zinc-400 leading-none font-bold" }, "دروس")
                            ]),
                            createVNode("div", { class: "flex flex-col items-center justify-center bg-zinc-50/60 p-1.5 rounded-lg border border-zinc-100/80" }, [
                              createVNode(unref(HelpCircle), { class: "h-3 w-3 text-zinc-400 mb-0.5" }),
                              createVNode("span", { class: "text-[9.5px] text-zinc-850 font-black leading-tight font-sans" }, toDisplayString(course.quizzes_count || 0), 1),
                              createVNode("span", { class: "text-[7.5px] text-zinc-400 leading-none font-bold" }, "اختبارات")
                            ])
                          ])
                        ]),
                        createVNode("div", { class: "px-4 pb-4 pt-1 flex items-center justify-between gap-2 border-t border-zinc-50 bg-zinc-50/20" }, [
                        ...
                        expandedCourses.value[course.id] ? (openBlock(), createBlock("div", {
                          key: 0,
                          class: "px-4 pb-4 pt-2.5 border-t border-zinc-100 bg-zinc-50/55 animate-in fade-in slide-in-from-top-2 duration-300"
                        }, [
                          createVNode("div", { class: "flex items-center gap-1.5 mb-2" }, [
                            createVNode(unref(Award), { class: "h-3.5 w-3.5 text-zinc-400" }),
                            createVNode("span", { class: "text-[9px] font-black text-zinc-400 uppercase tracking-widest" }, "منهج الدروس:")
                          ]),
                          course.lessons && course.lessons.length > 0 ? (openBlock(), createBlock("div", {
                            ...
                            (openBlock(true), createBlock(Fragment, null, renderList(course.lessons, (lesson, idx) => {
                              return openBlock(), createBlock("div", {
                                key: lesson.id,
                                class: "p-2 rounded-lg bg-white border border-zinc-200/50 hover:border-zinc-900/30 transition-all duration-200 flex items-center justify-between group/lesson"
                              }, [
                                createVNode("div", { class: "flex items-center gap-2 min-w-0" }, [
                                  createVNode("div", { class: "h-4.5 w-4.5 bg-zinc-950 text-white text-[8px] font-black rounded flex items-center justify-center shrink-0 shadow-xs select-none" }, toDisplayString(idx + 1), 1),
                                  createVNode("div", { class: "min-w-0" }, [
                                    createVNode("div", { class: "text-[9.5px] font-bold text-zinc-800 line-clamp-1 group-hover/lesson:text-zinc-950 transition-colors" }, toDisplayString(lesson.title), 1)
                                  ])
                                ]),
                                createVNode(unref(_sfc_main$4), {
                                  variant: "outline",
                            ...
                            createVNode(unref(PlayCircle), { class: "h-6 w-6 text-zinc-200 mb-1" }),
                            createVNode("div", { class: "text-[9.5px] font-bold text-zinc-400" }, "لا توجد دروس في الكورس بعد"),
                            createVNode(unref(Link), {
                              href: _ctx.route("teacher.lessons.create", course.id),
                              class: "mt-1 text-[8.5px] font-black text-zinc-950 hover:underline"
                            }, {
            ...
            _push2(`</section><section class="relative bg-white border-b border-zinc-200 p-6 lg:p-8 overflow-hidden space-y-6"${_scopeId}><div class="absolute inset-0 bg-[radial-gradient(#e4e4e7_1.2px,transparent_1.2px)] [background-size:24px_24px] opacity-60 pointer-events-none"${_scopeId}></div><div class="relative z-10 flex items-center justify-between border-b border-zinc-100 pb-3"${_scopeId}><div${_scopeId}><h2 class="text-[14px] font-black text-zinc-900 flex items-center gap-2"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(TrendingUp), { class: "h-4.5 w-4.5 text-zinc-400" }, null, _parent2, _scopeId));
            _push2(` لوحة الإحصائيات والأداء العام </h2><p class="text-[10px] text-zinc-400 mt-0.5"${_scopeId}>تقارير إجمالية حول الأداء المالي، المشاهدات والطلاب المسجلين.</p></div></div><div class="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(_sfc_main$5), { class: "border-zinc-200/80 shadow-none bg-white rounded-xl hover:border-zinc-400 hover:-translate-y-0.5 transition-all duration-300" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$6), { class: "p-4 flex flex-row items-center justify-between space-y-0 pb-1.5" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div class="h-8 w-8 rounded-lg bg-emerald-50/50 border border-emerald-100/50 text-emerald-600 flex items-center justify-center font-bold"${_scopeId3}>`);
                        ...
                        return [
                          ...
                          createVNode("div", { class: "h-8 w-8 rounded-lg bg-emerald-50/50 border border-emerald-100/50 text-emerald-600 flex items-center justify-center font-bold" }, [
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$8), { class: "p-4 pt-0" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-2xl font-black text-zinc-900 tracking-tighter font-sans"${_scopeId3}>$${ssrInterpolate(__props.stats.total_revenue)}</div><div class="flex items-center gap-1 mt-1"${_scopeId3}>`);
                        _push4(ssrRenderComponent(unref(_sfc_main$4), {
                          variant: "secondary",
                          class: "h-4 text-[8px] font-black bg-emerald-50 text-emerald-600 border-none px-1 rounded shadow-xs"
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`+20.1%`);
                        ...
                        return [
                          createVNode("div", { class: "text-2xl font-black text-zinc-900 tracking-tighter font-sans" }, "$" + toDisplayString(__props.stats.total_revenue), 1),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$6), { class: "p-4 flex flex-row items-center justify-between space-y-0 pb-1.5" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div class="h-8 w-8 rounded-lg bg-blue-50/50 border border-blue-100/50 text-blue-600 flex items-center justify-center font-bold"${_scopeId3}>`);
                        ...
                        return [
                          ...
                          createVNode("div", { class: "h-8 w-8 rounded-lg bg-blue-50/50 border border-blue-100/50 text-blue-600 flex items-center justify-center font-bold" }, [
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$8), { class: "p-4 pt-0" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-2xl font-black text-zinc-900 tracking-tighter font-sans"${_scopeId3}>${ssrInterpolate(__props.stats.total_students)}</div><div class="flex items-center gap-1 mt-1"${_scopeId3}>`);
                        _push4(ssrRenderComponent(unref(_sfc_main$4), {
                          variant: "secondary",
                          class: "h-4 text-[8px] font-black bg-blue-50 text-blue-600 border-none px-1 rounded shadow-xs"
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`+18%`);
                        ...
                        return [
                          createVNode("div", { class: "text-2xl font-black text-zinc-900 tracking-tighter font-sans" }, toDisplayString(__props.stats.total_students), 1),
                          createVNode("div", { class: "flex items-center gap-1 mt-1" }, [
                            createVNode(unref(_sfc_main$4), {
                              variant: "secondary",
                              class: "h-4 text-[8px] font-black bg-blue-50 text-blue-600 border-none px-1 rounded shadow-xs"
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$6), { class: "p-4 flex flex-row items-center justify-between space-y-0 pb-1.5" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div class="h-8 w-8 rounded-lg bg-purple-50/50 border border-purple-100/50 text-purple-600 flex items-center justify-center font-bold"${_scopeId3}>`);
                        ...
                        return [
                          ...
                          createVNode("div", { class: "h-8 w-8 rounded-lg bg-purple-50/50 border border-purple-100/50 text-purple-600 flex items-center justify-center font-bold" }, [
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$8), { class: "p-4 pt-0" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-2xl font-black text-zinc-900 tracking-tighter font-sans"${_scopeId3}>${ssrInterpolate(__props.stats.total_courses)}</div><div class="flex items-center gap-1.5 mt-1 text-[9px] text-zinc-400 font-bold"${_scopeId3}>`);
                        _push4(ssrRenderComponent(unref(Activity), { class: "h-3 w-3 text-purple-450" }, null, _parent4, _scopeId3));
                        _push4(`<span${_scopeId3}>تحديثات مستمرة ومنشورة</span></div>`);
                      } else {
                        return [
                          createVNode("div", { class: "text-2xl font-black text-zinc-900 tracking-tighter font-sans" }, toDisplayString(__props.stats.total_courses), 1),
                          createVNode("div", { class: "flex items-center gap-1.5 mt-1 text-[9px] text-zinc-400 font-bold" }, [
                            createVNode(unref(Activity), { class: "h-3 w-3 text-purple-450" }),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$6), { class: "p-4 flex flex-row items-center justify-between space-y-0 pb-1.5" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div class="h-8 w-8 rounded-lg bg-amber-50/50 border border-amber-100/50 text-amber-600 flex items-center justify-center font-bold"${_scopeId3}>`);
                        ...
                        return [
                          ...
                          createVNode("div", { class: "h-8 w-8 rounded-lg bg-amber-50/50 border border-amber-100/50 text-amber-600 flex items-center justify-center font-bold" }, [
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$8), { class: "p-4 pt-0" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-2xl font-black text-zinc-900 tracking-tighter font-sans"${_scopeId3}>${ssrInterpolate(__props.stats.total_lessons)}</div><div class="flex items-center gap-1 mt-1 text-[9px] text-zinc-400 font-black uppercase tracking-widest"${_scopeId3}>`);
                        ...
                        return [
                          createVNode("div", { class: "text-2xl font-black text-zinc-900 tracking-tighter font-sans" }, toDisplayString(__props.stats.total_lessons), 1),
            ...
            _push2(`</div></section><section class="relative bg-zinc-50/10 p-6 lg:p-8 overflow-hidden grid grid-cols-1 lg:grid-cols-3 gap-6"${_scopeId}><div class="absolute inset-0 bg-[radial-gradient(#e4e4e7_1.2px,transparent_1.2px)] [background-size:24px_24px] opacity-25 pointer-events-none"${_scopeId}></div>`);
            _push2(ssrRenderComponent(unref(_sfc_main$5), { class: "lg:col-span-2 border-zinc-200/80 shadow-none bg-white rounded-xl hover:border-zinc-400 transition-all duration-300 overflow-hidden flex flex-col relative z-10" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$5), { class: "border-zinc-200/80 shadow-none bg-white rounded-xl hover:border-zinc-400 transition-all duration-300 overflow-hidden flex flex-col relative z-10" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            return [
              createVNode("div", { class: "w-full text-right pb-12 space-y-0" }, [
                createVNode("section", { class: "relative bg-white border-b border-zinc-200 p-6 lg:p-8 overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6" }, [
                  createVNode("div", { class: "absolute inset-0 bg-[radial-gradient(#e4e4e7_1.2px,transparent_1.2px)] [background-size:24px_24px] opacity-60 pointer-events-none" }),
                ...
                createVNode("section", { class: "relative bg-zinc-50/30 border-b border-zinc-200 p-6 lg:p-8 overflow-hidden space-y-6" }, [
                  createVNode("div", { class: "absolute inset-0 bg-[radial-gradient(#e4e4e7_1.2px,transparent_1.2px)] [background-size:24px_24px] opacity-40 pointer-events-none" }),
                  ...
                  __props.courses.length === 0 ? (openBlock(), createBlock("div", {
                    key: 0,
                    class: "relative z-10 flex flex-col items-center justify-center py-20 border border-dashed border-zinc-200 bg-white/50 backdrop-blur-sm rounded-xl"
                  }, [
                    ...
                    ref_key: "carouselRef",
                    ref: carouselRef,
                    class: "relative z-10 flex gap-6 overflow-x-auto pb-4 pt-1 snap-x snap-mandatory scroll-smooth scrollbar-none"
                  }, [
                ...
                createVNode("section", { class: "relative bg-white border-b border-zinc-200 p-6 lg:p-8 overflow-hidden space-y-6" }, [
                  createVNode("div", { class: "absolute inset-0 bg-[radial-gradient(#e4e4e7_1.2px,transparent_1.2px)] [background-size:24px_24px] opacity-60 pointer-events-none" }),
                  createVNode("div", { class: "relative z-10 flex items-center justify-between border-b border-zinc-100 pb-3" }, [
                    createVNode("div", null, [
                      createVNode("h2", { class: "text-[14px] font-black text-zinc-900 flex items-center gap-2" }, [
                  ...
                  createVNode("div", { class: "relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6" }, [
                    createVNode(unref(_sfc_main$5), { class: "border-zinc-200/80 shadow-none bg-white rounded-xl hover:border-zinc-400 hover:-translate-y-0.5 transition-all duration-300" }, {
                      default: withCtx(() => [
                        createVNode(unref(_sfc_main$6), { class: "p-4 flex flex-row items-center justify-between space-y-0 pb-1.5" }, {
                          default: withCtx(() => [
                            createVNode(unref(_sfc_main$7), { class: "text-[9px] font-black text-zinc-400 uppercase tracking-widest" }, {
                ...
                createVNode("section", { class: "relative bg-zinc-50/10 p-6 lg:p-8 overflow-hidden grid grid-cols-1 lg:grid-cols-3 gap-6" }, [
                  createVNode("div", { class: "absolute inset-0 bg-[radial-gradient(#e4e4e7_1.2px,transparent_1.2px)] [background-size:24px_24px] opacity-25 pointer-events-none" }),
                  createVNode(unref(_sfc_main$5), { class: "lg:col-span-2 border-zinc-200/80 shadow-none bg-white rounded-xl hover:border-zinc-400 transition-all duration-300 overflow-hidden flex flex-col relative z-10" }, {
                    default: withCtx(() => [
                      createVNode(unref(_sfc_main$6), { class: "p-5 border-b border-zinc-100 flex flex-row items-center justify-between" }, {
                        default: withCtx(() => [
                          createVNode("div", null, [
                  ...
                  createVNode(unref(_sfc_main$5), { class: "border-zinc-200/80 shadow-none bg-white rounded-xl hover:border-zinc-400 transition-all duration-300 overflow-hidden flex flex-col relative z-10" }, {
                    default: withCtx(() => [
                      createVNode(unref(_sfc_main$6), { class: "p-5 border-b border-zinc-100" }, {
                        default: withCtx(() => [
                          createVNode(unref(_sfc_main$7), { class: "text-[12px] font-black flex items-center gap-2 text-zinc-900 uppercase tracking-tight" }, {
