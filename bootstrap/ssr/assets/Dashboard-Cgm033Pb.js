...
import { _ as _sfc_main$7 } from "./CourseCard-Dj4p1AJI.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$2), {
              ...
              size: "sm",
              class: "bg-zinc-100 text-zinc-900 hover:bg-zinc-200 border border-zinc-200 dark:bg-zinc-800 dark:text-zinc-50 dark:hover:bg-zinc-700 dark:border-zinc-700 font-bold gap-1.5 text-xs h-8"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            if (roadmapResult.value) {
              _push2(`<div class="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl p-5 relative overflow-hidden shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-500"${_scopeId}><div class="absolute top-0 left-0 w-full h-[3px] bg-zinc-900 dark:bg-zinc-100"${_scopeId}></div><div class="flex items-center gap-3 mb-6"${_scopeId}><div class="h-9 w-9 bg-zinc-100 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-50 rounded-lg flex items-center justify-center border border-zinc-200 dark:border-zinc-800"${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Map), { class: "h-5 w-5" }, null, _parent2, _scopeId));
              _push2(`</div><div${_scopeId}><h2 class="text-base font-black text-zinc-900 dark:text-white"${_scopeId}>خارطة طريقك المخصصة</h2><p class="text-zinc-500 text-xs font-medium mt-0.5"${_scopeId}>بناءً على هدفك ومستواك</p></div></div><div class="relative border-r-2 border-zinc-200 dark:border-zinc-800 pr-5 space-y-5"${_scopeId}><!--[-->`);
              ssrRenderList(roadmapResult.value, (phase, index) => {
                var _a;
                _push2(`<div class="relative"${_scopeId}><div class="absolute -right-[29px] top-1 w-4 h-4 bg-white dark:bg-zinc-950 border-4 border-zinc-900 dark:border-zinc-100 rounded-full"${_scopeId}></div><div class="bg-zinc-50/50 dark:bg-zinc-900/50 rounded-lg p-4 border border-zinc-100 dark:border-zinc-800"${_scopeId}><span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-50 text-[10px] font-black mb-3"${_scopeId}>`);
            ...
            if (showRoadmapModal.value) {
              ...
              _push2(ssrRenderComponent(unref(Target), { class: "h-3.5 w-3.5 text-zinc-900 dark:text-zinc-100" }, null, _parent2, _scopeId));
              _push2(` ما هو هدفك التعليمي؟ </label><input${ssrRenderAttr("value", roadmapForm.value.goal)} type="text" placeholder="مثال: أريد أن أصبح مطور ويب" class="w-full bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg p-2.5 text-xs focus:ring-1 focus:ring-zinc-950 dark:focus:ring-zinc-100 focus:border-zinc-950 dark:focus:border-zinc-100 outline-none"${_scopeId}></div><div class="space-y-1.5"${_scopeId}><label class="text-xs font-bold"${_scopeId}>مستواك الحالي</label><div class="grid grid-cols-3 gap-1.5"${_scopeId}><button class="${ssrRenderClass(["p-1.5 rounded-lg text-[10px] font-bold border-2 transition-all", roadmapForm.value.level === "beginner" ? "border-zinc-900 bg-zinc-900 text-white dark:border-zinc-100 dark:bg-zinc-100 dark:text-zinc-950" : "border-zinc-200 dark:border-zinc-800 text-zinc-500"])}"${_scopeId}>مبتدئ</button><button class="${ssrRenderClass(["p-1.5 rounded-lg text-[10px] font-bold border-2 transition-all", roadmapForm.value.level === "intermediate" ? "border-zinc-900 bg-zinc-900 text-white dark:border-zinc-100 dark:bg-zinc-100 dark:text-zinc-950" : "border-zinc-200 dark:border-zinc-800 text-zinc-500"])}"${_scopeId}>متوسط</button><button class="${ssrRenderClass(["p-1.5 rounded-lg text-[10px] font-bold border-2 transition-all", roadmapForm.value.level === "advanced" ? "border-zinc-900 bg-zinc-900 text-white dark:border-zinc-100 dark:bg-zinc-100 dark:text-zinc-950" : "border-zinc-200 dark:border-zinc-800 text-zinc-500"])}"${_scopeId}>متقدم</button></div></div><div class="space-y-1.5"${_scopeId}><label class="text-xs font-bold flex items-center gap-1.5"${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Calendar), { class: "h-3.5 w-3.5 text-zinc-900 dark:text-zinc-100" }, null, _parent2, _scopeId));
              _push2(` الوقت المتاح </label><input${ssrRenderAttr("value", roadmapForm.value.time)} type="text" placeholder="مثال: ساعتين يومياً" class="w-full bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg p-2.5 text-xs focus:ring-1 focus:ring-zinc-950 dark:focus:ring-zinc-100 focus:border-zinc-950 dark:focus:border-zinc-100 outline-none"${_scopeId}></div></div><div class="p-4 border-t border-zinc-100 dark:border-zinc-900 bg-zinc-50 dark:bg-zinc-900"${_scopeId}>`);
              _push2(ssrRenderComponent(unref(_sfc_main$2), {
                onClick: generateRoadmap,
                disabled: isGeneratingRoadmap.value || !roadmapForm.value.goal,
                class: "w-full bg-zinc-900 text-white hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-950 dark:hover:bg-zinc-200 h-9 text-xs rounded-lg font-bold"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
            ...
            return [
              createVNode("div", { class: "space-y-4" }, [
                ...
                roadmapResult.value ? (openBlock(), createBlock("div", {
                  key: 0,
                  class: "bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl p-5 relative overflow-hidden shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-500"
                }, [
                  createVNode("div", { class: "absolute top-0 left-0 w-full h-[3px] bg-zinc-900 dark:bg-zinc-100" }),
                  createVNode("div", { class: "flex items-center gap-3 mb-6" }, [
                    createVNode("div", { class: "h-9 w-9 bg-zinc-100 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-50 rounded-lg flex items-center justify-center border border-zinc-200 dark:border-zinc-800" }, [
                      createVNode(unref(Map), { class: "h-5 w-5" })
                    ]),
                    createVNode("div", null, [
                      createVNode("h2", { class: "text-base font-black text-zinc-900 dark:text-white" }, "خارطة طريقك المخصصة"),
                      createVNode("p", { class: "text-zinc-500 text-xs font-medium mt-0.5" }, "بناءً على هدفك ومستواك")
                    ])
                  ]),
                  createVNode("div", { class: "relative border-r-2 border-zinc-200 dark:border-zinc-800 pr-5 space-y-5" }, [
                    (openBlock(true), createBlock(Fragment, null, renderList(roadmapResult.value, (phase, index) => {
                      ...
                      return openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "absolute -right-[29px] top-1 w-4 h-4 bg-white dark:bg-zinc-950 border-4 border-zinc-900 dark:border-zinc-100 rounded-full" }),
                        createVNode("div", { class: "bg-zinc-50/50 dark:bg-zinc-900/50 rounded-lg p-4 border border-zinc-100 dark:border-zinc-800" }, [
                          createVNode("span", { class: "inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-50 text-[10px] font-black mb-3" }, [
                  ...
                  createVNode("div", { class: "p-4 space-y-4" }, [
                    createVNode("div", { class: "space-y-1.5" }, [
                      createVNode("label", { class: "text-xs font-bold flex items-center gap-1.5" }, [
                        createVNode(unref(Target), { class: "h-3.5 w-3.5 text-zinc-900 dark:text-zinc-100" }),
                      ...
                      withDirectives(createVNode("input", {
                        ...
                        class: "w-full bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg p-2.5 text-xs focus:ring-1 focus:ring-zinc-950 dark:focus:ring-zinc-100 focus:border-zinc-950 dark:focus:border-zinc-100 outline-none"
                    ...
                    createVNode("div", { class: "space-y-1.5" }, [
                      ...
                      createVNode("div", { class: "grid grid-cols-3 gap-1.5" }, [
                        createVNode("button", {
                          ...
                          class: ["p-1.5 rounded-lg text-[10px] font-bold border-2 transition-all", roadmapForm.value.level === "beginner" ? "border-zinc-900 bg-zinc-900 text-white dark:border-zinc-100 dark:bg-zinc-100 dark:text-zinc-950" : "border-zinc-200 dark:border-zinc-800 text-zinc-500"]
                        }, "مبتدئ", 10, ["onClick"]),
                        createVNode("button", {
                          onClick: ($event) => roadmapForm.value.level = "intermediate",
                          class: ["p-1.5 rounded-lg text-[10px] font-bold border-2 transition-all", roadmapForm.value.level === "intermediate" ? "border-zinc-900 bg-zinc-900 text-white dark:border-zinc-100 dark:bg-zinc-100 dark:text-zinc-950" : "border-zinc-200 dark:border-zinc-800 text-zinc-500"]
                        }, "متوسط", 10, ["onClick"]),
                        createVNode("button", {
                          onClick: ($event) => roadmapForm.value.level = "advanced",
                          class: ["p-1.5 rounded-lg text-[10px] font-bold border-2 transition-all", roadmapForm.value.level === "advanced" ? "border-zinc-900 bg-zinc-900 text-white dark:border-zinc-100 dark:bg-zinc-100 dark:text-zinc-950" : "border-zinc-200 dark:border-zinc-800 text-zinc-500"]
                        }, "متقدم", 10, ["onClick"])
                      ])
                    ]),
                    createVNode("div", { class: "space-y-1.5" }, [
                      createVNode("label", { class: "text-xs font-bold flex items-center gap-1.5" }, [
                        createVNode(unref(Calendar), { class: "h-3.5 w-3.5 text-zinc-900 dark:text-zinc-100" }),
