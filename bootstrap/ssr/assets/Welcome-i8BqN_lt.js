...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span>الجيل القادم من التعليم الإلكتروني الفخم</span></div><h1 class="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tighter leading-[1.1] text-zinc-950 mb-6"> تعلم ما يجعلك <span class="bg-zinc-950 text-white px-4 py-1.5 rounded-lg shadow-sm">خارج الصندوق</span></h1><p class="text-[13px] sm:text-[15px] text-zinc-500 font-normal leading-relaxed max-w-2xl mx-auto mb-8"> منصة تعليمية متكاملة تلتزم ببساطة التصميم وقوة المحتوى، مدعومة بمساعد ذكاء اصطناعي تفاعلي يبني لك مسارات تعلم مخصصة ومصممة بدقة لتناسب أهدافك. </p><div class="flex flex-col sm:flex-row items-center justify-center gap-3"><a href="#courses">`);
